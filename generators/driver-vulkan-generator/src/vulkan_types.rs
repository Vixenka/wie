...
pub fn generate_vulkan_types(project_directory: &Path, types: &TypeVulkan) {
    ...
    builder.push_str("//! THIS FILE IS GENERATED BY TOOL, DO NOT MODIFY.\n\nuse std::ffi::{c_char, c_void};\nuse crate::{NonDisposableHandle, p_next_serializer, p_next_deserializer, unimplemented_serializer, unimplemented_deserializer, unimplemented_deserializer_mut, generated::vulkan_enums::*, generated::vulkan_pfn_functions::*, generated::vulkan_bitmasks::*, generated::p_next::*};\nuse cdump::{CDeserialize, CSerialize, CDebug};\nuse ash::vk;\n");

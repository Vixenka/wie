...
use vkxml::{Bitmask, DefinitionsElement, EnumerationDeclaration, Handle, RegistryElement};
    ...
    for member in members {
        ...
        if is_dynamic && (!is_dynamic_type_exception(member_name, type_name) || def.len.is_none()) {
            ...
            if member_name == "pNext" {
                builder.push_str("#[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer))]\n");
            } else {

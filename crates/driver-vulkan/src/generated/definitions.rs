...
use wie_driver_common_vulkan::{generated::vulkan_pfn_functions::*, generated::vulkan_types::*, *};
...
unsafe extern "system" fn vkGetPhysicalDeviceQueueFamilyProperties(
    ...
    unsafe {
        trace!(
            ...
            p_queue_family_properties.as_ref()
        );
    }
...
unsafe extern "system" fn vkQueueWaitIdle(queue: NonDisposableHandle) -> NonDisposableHandle {
    unsafe {
...
unsafe extern "system" fn vkDeviceWaitIdle(device: NonDisposableHandle) -> NonDisposableHandle {
    unsafe {
...
unsafe extern "system" fn vkGetImageSparseMemoryRequirements(
    ...
    unsafe {
        trace!(
            ...
            p_sparse_memory_requirements.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceSparseImageFormatProperties(
    ...
    unsafe {
        trace!("called vkGetPhysicalDeviceSparseImageFormatProperties({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?})", physical_device, format, type_, samples, usage, tiling, p_property_count, p_properties.as_ref());
    }
...
unsafe extern "system" fn vkUpdateDescriptorSets(
    ...
    unsafe {
        trace!(
            ...
            p_descriptor_writes.as_ref(),
            descriptor_copy_count,
            p_descriptor_copies.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdWaitEvents(
    ...
    unsafe {
        trace!("called vkCmdWaitEvents({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?})", command_buffer, event_count, p_events.as_ref(), src_stage_mask, dst_stage_mask, memory_barrier_count, p_memory_barriers.as_ref(), buffer_memory_barrier_count, p_buffer_memory_barriers.as_ref(), image_memory_barrier_count, p_image_memory_barriers.as_ref());
    }
...
unsafe extern "system" fn vkCmdPipelineBarrier(
    ...
    unsafe {
        trace!("called vkCmdPipelineBarrier({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?})", command_buffer, src_stage_mask, dst_stage_mask, dependency_flags, memory_barrier_count, p_memory_barriers.as_ref(), buffer_memory_barrier_count, p_buffer_memory_barriers.as_ref(), image_memory_barrier_count, p_image_memory_barriers.as_ref());
    }
...
unsafe extern "system" fn vkEnumeratePhysicalDeviceGroups(
    ...
    unsafe {
        trace!(
            ...
            p_physical_device_group_properties.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdBeginTransformFeedbackEXT(
    ...
    unsafe {
        trace!(
            ...
            p_counter_buffers.as_ref(),
            p_counter_buffer_offsets.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdSetExclusiveScissorEnableNV(
    ...
    unsafe {
        trace!(
            ...
            first_exclusive_scissor,
            exclusive_scissor_count,
            p_exclusive_scissor_enables.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdSetViewportShadingRatePaletteNV(
    ...
    unsafe {
        trace!(
            ...
            first_viewport,
            viewport_count,
            p_shading_rate_palettes.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdWriteAccelerationStructuresPropertiesKHR(
    ...
    unsafe {
        trace!("called vkCmdWriteAccelerationStructuresPropertiesKHR({:?}, {:?}, {:?}, {:?}, {:?}, {:?})", command_buffer, acceleration_structure_count, p_acceleration_structures.as_ref(), query_type, query_pool, first_query);
    }
...
unsafe extern "system" fn vkCmdWriteAccelerationStructuresPropertiesNV(
    ...
    unsafe {
        trace!("called vkCmdWriteAccelerationStructuresPropertiesNV({:?}, {:?}, {:?}, {:?}, {:?}, {:?})", command_buffer, acceleration_structure_count, p_acceleration_structures.as_ref(), query_type, query_pool, first_query);
    }
...
unsafe extern "system" fn vkWriteAccelerationStructuresPropertiesKHR(
    ...
    unsafe {
        trace!("called vkWriteAccelerationStructuresPropertiesKHR({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?})", device, acceleration_structure_count, p_acceleration_structures.as_ref(), query_type, data_size, p_data.as_ref(), stride);
    }
...
unsafe extern "system" fn vkGetRayTracingCaptureReplayShaderGroupHandlesKHR(
    ...
    unsafe {
        trace!("called vkGetRayTracingCaptureReplayShaderGroupHandlesKHR({:?}, {:?}, {:?}, {:?}, {:?}, {:?})", device, pipeline, first_group, group_count, data_size, p_data.as_ref());
    }
...
unsafe extern "system" fn vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR(
    ...
    unsafe {
        trace!("called vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR({:?}, {:?}, {:?}, {:?}, {:?})", physical_device, queue_family_index, p_counter_count, p_counters.as_ref(), p_counter_descriptions.as_ref());
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV(
    ...
    unsafe {
        trace!("called vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV({:?}, {:?}, {:?})", physical_device, p_combination_count, p_combinations.as_ref());
    }
...
unsafe extern "system" fn vkGetPipelineExecutableInternalRepresentationsKHR(
    ...
    unsafe {
        trace!(
            ...
            p_internal_representations.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdBuildAccelerationStructuresIndirectKHR(
    ...
    unsafe {
        trace!("called vkCmdBuildAccelerationStructuresIndirectKHR({:?}, {:?}, {:?}, {:?}, {:?}, {:?})", command_buffer, info_count, p_infos.as_ref(), p_indirect_device_addresses.as_ref(), p_indirect_strides.as_ref(), pp_max_primitive_counts.as_ref());
    }
...
unsafe extern "system" fn vkCmdSetColorBlendEquationEXT(
    ...
    unsafe {
        trace!(
            ...
            first_attachment,
            attachment_count,
            p_color_blend_equations.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdSetCoverageModulationTableNV(
    ...
    unsafe {
        trace!(
            ...
            p_coverage_modulation_table.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceFragmentShadingRatesKHR(
    ...
    unsafe {
        trace!(
            ...
            p_fragment_shading_rates.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdSetVertexInputEXT(
    ...
    unsafe {
        trace!(
            ...
            p_vertex_binding_descriptions.as_ref(),
            vertex_attribute_description_count,
            p_vertex_attribute_descriptions.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceVideoFormatPropertiesKHR(
    ...
    unsafe {
        trace!(
            ...
            p_video_format_properties.as_ref()
        );
    }
...
unsafe extern "system" fn vkBindVideoSessionMemoryKHR(
    ...
    unsafe {
        trace!(
            ...
            p_bind_session_memory_infos.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdDecompressMemoryNV(
    ...
    unsafe {
        trace!(
            ...
            p_decompress_memory_regions.as_ref()
        );
    }

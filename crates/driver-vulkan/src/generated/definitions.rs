...
use wie_driver_common_vulkan::{
    generated::vulkan_bitmasks::*, generated::vulkan_pfn_functions::*, generated::vulkan_types::*,
    *,
};
...
pub(crate) fn get_function_address(name: &str) -> *const c_void {
    match name {
        ...
        "vkGetDeviceGroupPeerMemoryFeaturesKHR" => {
            vkGetDeviceGroupPeerMemoryFeatures as *const c_void
        }
        ...
        "vkDestroyDescriptorUpdateTemplateKHR" => {
            vkDestroyDescriptorUpdateTemplate as *const c_void
        }
        "vkUpdateDescriptorSetWithTemplate" => vkUpdateDescriptorSetWithTemplate as *const c_void,
        "vkUpdateDescriptorSetWithTemplateKHR" => {
            vkUpdateDescriptorSetWithTemplate as *const c_void
        }
        ...
        "vkGetDeviceImageMemoryRequirementsKHR" => {
            vkGetDeviceImageMemoryRequirements as *const c_void
        }
        ...
        "vkGetPhysicalDeviceToolPropertiesEXT" => {
            vkGetPhysicalDeviceToolProperties as *const c_void
        }
...
unsafe extern "system" fn vkEnumeratePhysicalDevices(
    ...
    unsafe {
        trace!(
            ...
            instance,
            p_physical_device_count.as_ref(),
            unpack_vk_array(p_physical_devices, (p_physical_device_count) as usize)
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceQueueFamilyProperties(
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            p_queue_family_property_count.as_ref(),
            unpack_vk_array(
...
unsafe extern "system" fn vkEnumerateInstanceLayerProperties(
    ...
    unsafe {
        trace!(
            ...
            p_property_count.as_ref(),
            unpack_vk_array(p_properties, (p_property_count) as usize)
        );
    }
...
unsafe extern "system" fn vkQueueSubmit(
    ...
    unsafe {
        trace!(
            ...
            queue,
            submit_count,
            unpack_vk_array(p_submits, (submit_count) as usize),
            fence
        );
    }
...
unsafe extern "system" fn vkFlushMappedMemoryRanges(
    ...
    unsafe {
        trace!(
            ...
            device,
            memory_range_count,
            unpack_vk_array(p_memory_ranges, (memory_range_count) as usize)
        );
    }
...
unsafe extern "system" fn vkGetDeviceMemoryCommitment(
    ...
    unsafe {
        trace!(
            ...
            device,
            memory,
            p_committed_memory_in_bytes.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetImageSparseMemoryRequirements(
    ...
    unsafe {
        trace!(
            ...
            device,
            image,
            p_sparse_memory_requirement_count.as_ref(),
            unpack_vk_array(
...
unsafe extern "system" fn vkQueueBindSparse(
    ...
    unsafe {
        trace!(
            ...
            queue,
            bind_info_count,
            unpack_vk_array(p_bind_info, (bind_info_count) as usize),
            fence
        );
    }
...
unsafe extern "system" fn vkResetFences(
    ...
    unsafe {
        trace!(
            ...
            device,
            fence_count,
            unpack_vk_array(p_fences, (fence_count) as usize)
        );
    }
...
unsafe extern "system" fn vkGetQueryPoolResults(
    ...
    unsafe {
        trace!(
            ...
            query_count,
            data_size,
            unpack_vk_array(p_data, (data_size) as usize),
            stride,
            flags
        );
    }
...
unsafe extern "system" fn vkGetPipelineCacheData(
    ...
    unsafe {
        trace!(
            ...
            pipeline_cache,
            p_data_size.as_ref(),
            unpack_vk_array(p_data, (p_data_size) as usize)
        );
    }
...
unsafe extern "system" fn vkMergePipelineCaches(
    ...
    unsafe {
        trace!(
            ...
            dst_cache,
            src_cache_count,
            unpack_vk_array(p_src_caches, (src_cache_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCreateGraphicsPipelines(
    ...
    unsafe {
        trace!(
            ...
            pipeline_cache,
            create_info_count,
            unpack_vk_array(p_create_infos, (create_info_count) as usize),
            p_allocator.as_ref(),
            unpack_vk_array(p_pipelines, (create_info_count) as usize)
        );
    }
...
unsafe extern "system" fn vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI(
    ...
    unsafe {
        trace!(
            ...
            device,
            renderpass,
            unpack_vk_array(p_max_workgroup_size, (1) as usize)
        );
    }
...
unsafe extern "system" fn vkAllocateDescriptorSets(
    ...
    unsafe {
        trace!(
            ...
            unpack_vk_array(
                p_descriptor_sets,
                ((&*p_allocate_info).descriptor_set_count) as usize
            )
        );
    }
...
unsafe extern "system" fn vkFreeDescriptorSets(
    ...
    unsafe {
        trace!(
            ...
            unpack_vk_array(p_descriptor_sets, (descriptor_set_count) as usize)
        );
    }
...
unsafe extern "system" fn vkUpdateDescriptorSets(
    ...
    unsafe {
        trace!(
            ...
            unpack_vk_array(p_descriptor_writes, (descriptor_write_count) as usize),
            descriptor_copy_count,
            unpack_vk_array(p_descriptor_copies, (descriptor_copy_count) as usize)
        );
    }
...
unsafe extern "system" fn vkAllocateCommandBuffers(
    ...
    unsafe {
        trace!(
            ...
            unpack_vk_array(
                p_command_buffers,
                ((&*p_allocate_info).command_buffer_count) as usize
            )
        );
    }
...
unsafe extern "system" fn vkFreeCommandBuffers(
    ...
    unsafe {
        trace!(
            ...
            unpack_vk_array(p_command_buffers, (command_buffer_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdSetViewport(
    ...
    unsafe {
        trace!(
            ...
            first_viewport,
            viewport_count,
            unpack_vk_array(p_viewports, (viewport_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdSetScissor(
    ...
    unsafe {
        trace!(
            ...
            first_scissor,
            scissor_count,
            unpack_vk_array(p_scissors, (scissor_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdBindDescriptorSets(
    ...
    unsafe {
        trace!(
            ...
            unpack_vk_array(p_dynamic_offsets, (dynamic_offset_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdBindVertexBuffers(
    ...
    unsafe {
        trace!(
            ...
            first_binding,
            binding_count,
            unpack_vk_array(p_buffers, (binding_count) as usize),
            unpack_vk_array(p_offsets, (binding_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdDrawMultiEXT(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            draw_count,
            unpack_vk_array(p_vertex_info, (draw_count) as usize),
            instance_count,
            first_instance,
            stride
        );
...
unsafe extern "system" fn vkCmdDrawMultiIndexedEXT(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            draw_count,
            unpack_vk_array(p_index_info, (draw_count) as usize),
            instance_count,
            first_instance,
            stride,
            p_vertex_offset.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdCopyBuffer(
    ...
    unsafe {
        trace!(
            ...
            dst_buffer,
            region_count,
            unpack_vk_array(p_regions, (region_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdCopyMemoryToImageIndirectNV(
    ...
    unsafe {
        trace!(
            ...
            dst_image,
            dst_image_layout,
            unpack_vk_array(p_image_subresources, (copy_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdClearColorImage(
    ...
    unsafe {
        trace!(
            ...
            p_color.as_ref(),
            range_count,
            unpack_vk_array(p_ranges, (range_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdClearAttachments(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            attachment_count,
            unpack_vk_array(p_attachments, (attachment_count) as usize),
            rect_count,
            unpack_vk_array(p_rects, (rect_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdBeginConditionalRenderingEXT(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            p_conditional_rendering_begin.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdPushConstants(
    ...
    unsafe {
        trace!(
            ...
            offset,
            size,
            unpack_vk_array(p_values, (size) as usize)
        );
    }
...
unsafe extern "system" fn vkGetDisplayPlaneSupportedDisplaysKHR(
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            plane_index,
            p_display_count.as_ref(),
            unpack_vk_array(p_displays, (p_display_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCreateSharedSwapchainsKHR(
    ...
    unsafe {
        trace!(
            ...
            device,
            swapchain_count,
            unpack_vk_array(p_create_infos, (swapchain_count) as usize),
            p_allocator.as_ref(),
            unpack_vk_array(p_swapchains, (swapchain_count) as usize)
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceSurfaceFormatsKHR(
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            surface,
            p_surface_format_count.as_ref(),
            unpack_vk_array(p_surface_formats, (p_surface_format_count) as usize)
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceSurfacePresentModesKHR(
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            surface,
            p_present_mode_count.as_ref(),
            unpack_vk_array(p_present_modes, (p_present_mode_count) as usize)
        );
    }
...
unsafe extern "system" fn vkGetSwapchainImagesKHR(
    ...
    unsafe {
        trace!(
            ...
            device,
            swapchain,
            p_swapchain_image_count.as_ref(),
            unpack_vk_array(p_swapchain_images, (p_swapchain_image_count) as usize)
        );
    }
...
unsafe extern "system" fn vkDebugReportMessageEXT(
    ...
    unsafe {
        trace!(
            ...
            location,
            message_code,
            unpack_cstr(p_layer_prefix),
            unpack_cstr(p_message)
        );
    }
...
unsafe extern "system" fn vkCmdExecuteGeneratedCommandsNV(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            is_preprocessed,
            p_generated_commands_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkCreateIndirectCommandsLayoutNV(
    ...
    unsafe {
        trace!(
            ...
            p_create_info.as_ref(),
            p_allocator.as_ref(),
            p_indirect_commands_layout.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceImageFormatProperties2(
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            p_image_format_info.as_ref(),
            p_image_format_properties.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceExternalBufferProperties(
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            p_external_buffer_info.as_ref(),
            p_external_buffer_properties.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetMemoryWin32HandleKHR(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_get_win32_handle_info.as_ref(),
            p_handle.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetMemoryWin32HandlePropertiesKHR(
    ...
    unsafe {
        trace!(
            ...
            handle_type,
            handle,
            p_memory_win32_handle_properties.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetMemoryZirconHandleFUCHSIA(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_get_zircon_handle_info.as_ref(),
            p_zircon_handle.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetMemoryZirconHandlePropertiesFUCHSIA(
    ...
    unsafe {
        trace!(
            ...
            handle_type,
            zircon_handle,
            p_memory_zircon_handle_properties.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetMemoryRemoteAddressNV(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_memory_get_remote_address_info.as_ref(),
            p_address.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceExternalSemaphoreProperties(
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            p_external_semaphore_info.as_ref(),
            p_external_semaphore_properties.as_ref()
        );
    }
...
unsafe extern "system" fn vkImportSemaphoreWin32HandleKHR(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_import_semaphore_win32_handle_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkImportSemaphoreFdKHR(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_import_semaphore_fd_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkImportSemaphoreZirconHandleFUCHSIA(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_import_semaphore_zircon_handle_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceExternalFenceProperties(
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            p_external_fence_info.as_ref(),
            p_external_fence_properties.as_ref()
        );
    }
...
unsafe extern "system" fn vkImportFenceWin32HandleKHR(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_import_fence_win32_handle_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkEnumeratePhysicalDeviceGroups(
    ...
    unsafe {
        trace!(
            ...
            instance,
            p_physical_device_group_count.as_ref(),
            unpack_vk_array(
...
unsafe extern "system" fn vkBindBufferMemory2(
    ...
    unsafe {
        trace!(
            ...
            device,
            bind_info_count,
            unpack_vk_array(p_bind_infos, (bind_info_count) as usize)
        );
    }
...
unsafe extern "system" fn vkGetDeviceGroupPresentCapabilitiesKHR(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_device_group_present_capabilities.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDevicePresentRectanglesKHR(
    ...
    unsafe {
        trace!(
            ...
            surface,
            p_rect_count.as_ref(),
            unpack_vk_array(p_rects, (p_rect_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCreateDescriptorUpdateTemplate(
    ...
    unsafe {
        trace!(
            ...
            p_create_info.as_ref(),
            p_allocator.as_ref(),
            p_descriptor_update_template.as_ref()
        );
    }
...
unsafe extern "system" fn vkSetHdrMetadataEXT(
    ...
    unsafe {
        trace!(
            ...
            swapchain_count,
            unpack_vk_array(p_swapchains, (swapchain_count) as usize),
            unpack_vk_array(p_metadata, (swapchain_count) as usize)
        );
    }
...
unsafe extern "system" fn vkGetRefreshCycleDurationGOOGLE(
    ...
    unsafe {
        trace!(
            ...
            device,
            swapchain,
            p_display_timing_properties.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetPastPresentationTimingGOOGLE(
    ...
    unsafe {
        trace!(
            ...
            device,
            swapchain,
            p_presentation_timing_count.as_ref(),
            unpack_vk_array(
...
unsafe extern "system" fn vkCmdSetViewportWScalingNV(
    ...
    unsafe {
        trace!(
            ...
            first_viewport,
            viewport_count,
            unpack_vk_array(p_viewport_wscalings, (viewport_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdSetDiscardRectangleEXT(
    ...
    unsafe {
        trace!(
            ...
            unpack_vk_array(p_discard_rectangles, (discard_rectangle_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdSetSampleLocationsEXT(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            p_sample_locations_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceMultisamplePropertiesEXT(
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            samples,
            p_multisample_properties.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetSwapchainGrallocUsage2ANDROID(
    ...
    unsafe {
        trace!(
            ...
            gralloc_consumer_usage.as_ref(),
            gralloc_producer_usage.as_ref()
        );
    }
...
unsafe extern "system" fn vkQueueSignalReleaseImageANDROID(
    ...
    unsafe {
        trace!(
            ...
            unpack_vk_array(p_wait_semaphores, (wait_semaphore_count) as usize),
            image,
            p_native_fence_fd.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetShaderInfoAMD(
    ...
    unsafe {
        trace!(
            ...
            info_type,
            p_info_size.as_ref(),
            unpack_vk_array(p_info, (p_info_size) as usize)
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceCalibrateableTimeDomainsKHR(
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            p_time_domain_count.as_ref(),
            unpack_vk_array(p_time_domains, (p_time_domain_count) as usize)
        );
    }
...
unsafe extern "system" fn vkGetCalibratedTimestampsKHR(
    ...
    unsafe {
        trace!(
            ...
            device,
            timestamp_count,
            unpack_vk_array(p_timestamp_infos, (timestamp_count) as usize),
            unpack_vk_array(p_timestamps, (timestamp_count) as usize),
            p_max_deviation.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetMemoryHostPointerPropertiesEXT(
    ...
    unsafe {
        trace!(
            ...
            device,
            handle_type,
            p_host_pointer.as_ref(),
            p_memory_host_pointer_properties.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetQueueCheckpointDataNV(
    ...
    unsafe {
        trace!(
            ...
            queue,
            p_checkpoint_data_count.as_ref(),
            unpack_vk_array(p_checkpoint_data, (p_checkpoint_data_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdBindTransformFeedbackBuffersEXT(
    ...
    unsafe {
        trace!(
            ...
            unpack_vk_array(p_buffers, (binding_count) as usize),
            unpack_vk_array(p_offsets, (binding_count) as usize),
            unpack_vk_array(p_sizes, (binding_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdBeginTransformFeedbackEXT(
    ...
    unsafe {
        trace!(
            ...
            unpack_vk_array(p_counter_buffers, (counter_buffer_count) as usize),
            unpack_vk_array(p_counter_buffer_offsets, (counter_buffer_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdSetExclusiveScissorNV(
    ...
    unsafe {
        trace!(
            ...
            unpack_vk_array(p_exclusive_scissors, (exclusive_scissor_count) as usize)
        );
    }
    ...
    unsafe {
        trace!(
            ...
            unpack_vk_array(
                ...
                (exclusive_scissor_count) as usize
            )
        );
    }
...
unsafe extern "system" fn vkCmdSetViewportShadingRatePaletteNV(
    ...
    unsafe {
        trace!(
            ...
            first_viewport,
            viewport_count,
            unpack_vk_array(p_shading_rate_palettes, (viewport_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdSetCoarseSampleOrderNV(
    ...
    unsafe {
        trace!(
            ...
            unpack_vk_array(p_custom_sample_orders, (custom_sample_order_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCreateAccelerationStructureNV(
    ...
    unsafe {
        trace!(
            ...
            p_create_info.as_ref(),
            p_allocator.as_ref(),
            p_acceleration_structure.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdTraceRaysKHR(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            p_raygen_shader_binding_table.as_ref(),
            p_miss_shader_binding_table.as_ref(),
            p_hit_shader_binding_table.as_ref(),
            p_callable_shader_binding_table.as_ref(),
            width,
            height,
            depth
        );
...
unsafe extern "system" fn vkGetDeviceAccelerationStructureCompatibilityKHR(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_version_info.as_ref(),
            p_compatibility.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR(
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            p_performance_query_create_info.as_ref(),
            p_num_passes.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetPipelineExecutablePropertiesKHR(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_pipeline_info.as_ref(),
            p_executable_count.as_ref(),
            unpack_vk_array(p_properties, (p_executable_count) as usize)
        );
    }
...
unsafe extern "system" fn vkGetPipelineExecutableStatisticsKHR(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_executable_info.as_ref(),
            p_statistic_count.as_ref(),
            unpack_vk_array(p_statistics, (p_statistic_count) as usize)
        );
    }
...
unsafe extern "system" fn vkGetPipelineExecutableInternalRepresentationsKHR(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_executable_info.as_ref(),
            p_internal_representation_count.as_ref(),
            unpack_vk_array(
...
unsafe extern "system" fn vkGetPhysicalDeviceToolProperties(
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            p_tool_count.as_ref(),
            unpack_vk_array(p_tool_properties, (p_tool_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdBuildAccelerationStructuresKHR(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            info_count,
            unpack_vk_array(p_infos, (info_count) as usize),
            unpack_vk_array(pp_build_range_infos, (info_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdBindVertexBuffers2(
    ...
    unsafe {
        trace!(
            ...
            unpack_vk_array(p_offsets, (binding_count) as usize),
            unpack_vk_array(p_sizes, (binding_count) as usize),
            unpack_vk_array(p_strides, (binding_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdSetSampleMaskEXT(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            samples,
            unpack_vk_array(p_sample_mask, ((samples.as_raw() + 31) / 32) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdSetColorBlendEnableEXT(
    ...
    unsafe {
        trace!(
            ...
            first_attachment,
            attachment_count,
            unpack_vk_array(p_color_blend_enables, (attachment_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdSetColorBlendEquationEXT(
    ...
    unsafe {
        trace!(
            ...
            first_attachment,
            attachment_count,
            unpack_vk_array(p_color_blend_equations, (attachment_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdSetColorWriteMaskEXT(
    ...
    unsafe {
        trace!(
            ...
            first_attachment,
            attachment_count,
            unpack_vk_array(p_color_write_masks, (attachment_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdSetColorBlendAdvancedEXT(
    ...
    unsafe {
        trace!(
            ...
            first_attachment,
            attachment_count,
            unpack_vk_array(p_color_blend_advanced, (attachment_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdSetViewportSwizzleNV(
    ...
    unsafe {
        trace!(
            ...
            first_viewport,
            viewport_count,
            unpack_vk_array(p_viewport_swizzles, (viewport_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdCopyBufferToImage2(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            p_copy_buffer_to_image_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdCopyImageToBuffer2(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            p_copy_image_to_buffer_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceFragmentShadingRatesKHR(
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            p_fragment_shading_rate_count.as_ref(),
            unpack_vk_array(
    ...
    unsafe {
        trace!(
            ...
            unpack_vk_array(
                ...
                ((&*p_build_info).geometry_count) as usize
            ),
            p_size_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdSetColorWriteEnableEXT(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            attachment_count,
            unpack_vk_array(p_color_write_enables, (attachment_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdWaitEvents2(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            event_count,
            unpack_vk_array(p_events, (event_count) as usize),
            unpack_vk_array(p_dependency_infos, (event_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCopyMemoryToImageEXT(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_copy_memory_to_image_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkCopyImageToMemoryEXT(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_copy_image_to_memory_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkCopyImageToImageEXT(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_copy_image_to_image_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkTransitionImageLayoutEXT(
    ...
    unsafe {
        trace!(
            ...
            device,
            transition_count,
            unpack_vk_array(p_transitions, (transition_count) as usize)
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceVideoFormatPropertiesKHR(
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            p_video_format_info.as_ref(),
            p_video_format_property_count.as_ref(),
            unpack_vk_array(
...
unsafe extern "system" fn vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR(
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            p_quality_level_info.as_ref(),
            p_quality_level_properties.as_ref()
        );
    }
...
unsafe extern "system" fn vkCreateVideoSessionParametersKHR(
    ...
    unsafe {
        trace!(
            ...
            p_create_info.as_ref(),
            p_allocator.as_ref(),
            p_video_session_parameters.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetEncodedVideoSessionParametersKHR(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_video_session_parameters_info.as_ref(),
            p_feedback_info.as_ref(),
            p_data_size.as_ref(),
            unpack_vk_array(p_data, (p_data_size) as usize)
        );
    }
...
unsafe extern "system" fn vkGetVideoSessionMemoryRequirementsKHR(
    ...
    unsafe {
        trace!(
            ...
            device,
            video_session,
            p_memory_requirements_count.as_ref(),
            unpack_vk_array(
                p_memory_requirements,
                (p_memory_requirements_count) as usize
            )
        );
    }
...
unsafe extern "system" fn vkGetDescriptorEXT(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_descriptor_info.as_ref(),
            data_size,
            unpack_vk_array(p_descriptor, (data_size) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdBindDescriptorBuffersEXT(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            buffer_count,
            unpack_vk_array(p_binding_infos, (buffer_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdSetDescriptorBufferOffsetsEXT(
    ...
    unsafe {
        trace!(
            ...
            first_set,
            set_count,
            unpack_vk_array(p_buffer_indices, (set_count) as usize),
            unpack_vk_array(p_offsets, (set_count) as usize)
        );
    }
...
unsafe extern "system" fn vkSetBufferCollectionBufferConstraintsFUCHSIA(
    ...
    unsafe {
        trace!(
            ...
            device,
            collection,
            p_buffer_constraints_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkSetBufferCollectionImageConstraintsFUCHSIA(
    ...
    unsafe {
        trace!(
            ...
            device,
            collection,
            p_image_constraints_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkGetCudaModuleCacheNV(
    ...
    unsafe {
        trace!(
            ...
            module,
            p_cache_size.as_ref(),
            unpack_vk_array(p_cache_data, (p_cache_size) as usize)
        );
    }
...
unsafe extern "system" fn vkGetDescriptorSetLayoutHostMappingInfoVALVE(
    ...
    unsafe {
        trace!(
            ...
            device,
            p_binding_reference.as_ref(),
            p_host_mapping.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdWriteMicromapsPropertiesEXT(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            micromap_count,
            unpack_vk_array(p_micromaps, (micromap_count) as usize),
            query_type,
            query_pool,
            first_query
        );
...
unsafe extern "system" fn vkGetFramebufferTilePropertiesQCOM(
    ...
    unsafe {
        trace!(
            ...
            device,
            framebuffer,
            p_properties_count.as_ref(),
            unpack_vk_array(p_properties, (p_properties_count) as usize)
        );
    }
...
unsafe extern "system" fn vkGetPhysicalDeviceOpticalFlowImageFormatsNV(
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            p_optical_flow_image_format_info.as_ref(),
            p_format_count.as_ref(),
            unpack_vk_array(p_image_format_properties, (p_format_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCreateShadersEXT(
    ...
    unsafe {
        trace!(
            ...
            unpack_vk_array(p_create_infos, (create_info_count) as usize),
            p_allocator.as_ref(),
            unpack_vk_array(p_shaders, (create_info_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdBindShadersEXT(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            stage_count,
            unpack_vk_array(p_stages, (stage_count) as usize),
            unpack_vk_array(p_shaders, (stage_count) as usize)
        );
    }
...
unsafe extern "system" fn vkCmdBindDescriptorSets2KHR(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            p_bind_descriptor_sets_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdPushDescriptorSet2KHR(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            p_push_descriptor_set_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdPushDescriptorSetWithTemplate2KHR(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            p_push_descriptor_set_with_template_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdSetDescriptorBufferOffsets2EXT(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            p_set_descriptor_buffer_offsets_info.as_ref()
        );
    }
...
unsafe extern "system" fn vkCmdBindDescriptorBufferEmbeddedSamplers2EXT(
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            p_bind_descriptor_buffer_embedded_samplers_info.as_ref()
        );
    }

...
pub type PFN_vkEnumerateInstanceVersion =
    unsafe extern "system" fn(p_api_version: *mut u32) -> NonDisposableHandle;
...
pub type PFN_vkQueueWaitIdle =
    unsafe extern "system" fn(queue: NonDisposableHandle) -> NonDisposableHandle;

#[allow(non_camel_case_types)]
#[doc = "<https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/vkDeviceWaitIdle.html>"]
pub type PFN_vkDeviceWaitIdle =
    unsafe extern "system" fn(device: NonDisposableHandle) -> NonDisposableHandle;
...
pub type PFN_vkUnmapMemory =
    unsafe extern "system" fn(device: NonDisposableHandle, memory: NonDisposableHandle) -> c_void;
...
pub type PFN_vkEndCommandBuffer =
    unsafe extern "system" fn(command_buffer: NonDisposableHandle) -> NonDisposableHandle;
...
pub type PFN_vkCmdSetLineWidth =
    unsafe extern "system" fn(command_buffer: NonDisposableHandle, line_width: f32) -> c_void;
...
pub type PFN_vkCmdSubpassShadingHUAWEI =
    unsafe extern "system" fn(command_buffer: NonDisposableHandle) -> c_void;
...
pub type PFN_vkCmdSetDeviceMask =
    unsafe extern "system" fn(command_buffer: NonDisposableHandle, device_mask: u32) -> c_void;
...
pub type PFN_vkQueueEndDebugUtilsLabelEXT =
    unsafe extern "system" fn(queue: NonDisposableHandle) -> c_void;
...
pub type PFN_vkReleaseProfilingLockKHR =
    unsafe extern "system" fn(device: NonDisposableHandle) -> c_void;
...
pub type PFN_vkGetDeferredOperationMaxConcurrencyKHR =
    unsafe extern "system" fn(device: NonDisposableHandle, operation: NonDisposableHandle) -> u32;

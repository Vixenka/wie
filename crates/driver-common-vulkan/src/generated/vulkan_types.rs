...
pub struct VkApplicationInfo {
    pub s_type: VkStructureType,
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
...
pub struct VkImageFormatProperties {
    ...
    pub max_resource_size: vk::DeviceSize,
}
...
pub struct VkSubresourceLayout {
    pub offset: vk::DeviceSize,
    pub size: vk::DeviceSize,
    pub row_pitch: vk::DeviceSize,
    pub array_pitch: vk::DeviceSize,
    pub depth_pitch: vk::DeviceSize,
}
...
pub struct VkCopyMemoryIndirectCommandNV {
    pub src_address: vk::DeviceAddress,
    pub dst_address: vk::DeviceAddress,
    pub size: vk::DeviceSize,
}
...
pub struct VkComputePipelineIndirectBufferInfoNV {
    ...
    pub size: vk::DeviceSize,
    pub pipeline_device_address_capture_replay: vk::DeviceAddress,
}
...
pub struct VkPipelineInputAssemblyStateCreateInfo {
    ...
    pub primitive_restart_enable: vk::Bool32,
}
...
pub struct VkCommandBufferInheritanceInfo {
    ...
    pub occlusion_query_enable: vk::Bool32,
...
pub struct VkPhysicalDeviceFeatures {
    pub robust_buffer_access: vk::Bool32,
    pub full_draw_index_uint32: vk::Bool32,
    pub image_cube_array: vk::Bool32,
    pub independent_blend: vk::Bool32,
    pub geometry_shader: vk::Bool32,
    pub tessellation_shader: vk::Bool32,
    pub sample_rate_shading: vk::Bool32,
    pub dual_src_blend: vk::Bool32,
    pub logic_op: vk::Bool32,
    pub multi_draw_indirect: vk::Bool32,
    pub draw_indirect_first_instance: vk::Bool32,
    pub depth_clamp: vk::Bool32,
    pub depth_bias_clamp: vk::Bool32,
    pub fill_mode_non_solid: vk::Bool32,
    pub depth_bounds: vk::Bool32,
    pub wide_lines: vk::Bool32,
    pub large_points: vk::Bool32,
    pub alpha_to_one: vk::Bool32,
    pub multi_viewport: vk::Bool32,
    pub sampler_anisotropy: vk::Bool32,
    pub texture_compression_etc2: vk::Bool32,
    pub texture_compression_astc_ldr: vk::Bool32,
    pub texture_compression_bc: vk::Bool32,
    pub occlusion_query_precise: vk::Bool32,
    pub pipeline_statistics_query: vk::Bool32,
    pub vertex_pipeline_stores_and_atomics: vk::Bool32,
    pub fragment_stores_and_atomics: vk::Bool32,
    pub shader_tessellation_and_geometry_point_size: vk::Bool32,
    pub shader_image_gather_extended: vk::Bool32,
    pub shader_storage_image_extended_formats: vk::Bool32,
    pub shader_storage_image_multisample: vk::Bool32,
    pub shader_storage_image_read_without_format: vk::Bool32,
    pub shader_storage_image_write_without_format: vk::Bool32,
    pub shader_uniform_buffer_array_dynamic_indexing: vk::Bool32,
    pub shader_sampled_image_array_dynamic_indexing: vk::Bool32,
    pub shader_storage_buffer_array_dynamic_indexing: vk::Bool32,
    pub shader_storage_image_array_dynamic_indexing: vk::Bool32,
    pub shader_clip_distance: vk::Bool32,
    pub shader_cull_distance: vk::Bool32,
    pub shader_float64: vk::Bool32,
    pub shader_int64: vk::Bool32,
    pub shader_int16: vk::Bool32,
    pub shader_resource_residency: vk::Bool32,
    pub shader_resource_min_lod: vk::Bool32,
    pub sparse_binding: vk::Bool32,
    pub sparse_residency_buffer: vk::Bool32,
    pub sparse_residency_image2_d: vk::Bool32,
    pub sparse_residency_image3_d: vk::Bool32,
    pub sparse_residency2_samples: vk::Bool32,
    pub sparse_residency4_samples: vk::Bool32,
    pub sparse_residency8_samples: vk::Bool32,
    pub sparse_residency16_samples: vk::Bool32,
    pub sparse_residency_aliased: vk::Bool32,
    pub variable_multisample_rate: vk::Bool32,
    pub inherited_queries: vk::Bool32,
}
...
pub struct VkPhysicalDeviceSparseProperties {
    pub residency_standard2_dblock_shape: vk::Bool32,
    pub residency_standard2_dmultisample_block_shape: vk::Bool32,
    pub residency_standard3_dblock_shape: vk::Bool32,
    pub residency_aligned_mip_size: vk::Bool32,
    pub residency_non_resident_strict: vk::Bool32,
}
...
pub struct VkPhysicalDeviceLimits {
    ...
    pub timestamp_compute_and_graphics: vk::Bool32,
    ...
    pub strict_lines: vk::Bool32,
    pub standard_sample_locations: vk::Bool32,
...
pub struct VkDisplayPropertiesKHR {
    ...
    pub plane_reorder_possible: vk::Bool32,
    pub persistent_content: vk::Bool32,
}
...
pub struct VkValidationFlagsEXT {
    ...
    pub p_disabled_validation_checks: *const VkValidationCheckEXT,
}
...
pub struct VkValidationFeaturesEXT {
    ...
    pub p_enabled_validation_features: *const VkValidationFeatureEnableEXT,
    pub disabled_validation_feature_count: u32,
    #[cdump(array(len = self.disabled_validation_feature_count))]
    pub p_disabled_validation_features: *const VkValidationFeatureDisableEXT,
}
...
pub struct VkDedicatedAllocationImageCreateInfoNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub dedicated_allocation: vk::Bool32,
}
...
pub struct VkPhysicalDeviceDeviceGeneratedCommandsFeaturesNV {
    ...
    pub device_generated_commands: vk::Bool32,
}
...
pub struct VkPhysicalDeviceDeviceGeneratedCommandsComputeFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub device_generated_compute: vk::Bool32,
    pub device_generated_compute_pipelines: vk::Bool32,
    pub device_generated_compute_capture_replay: vk::Bool32,
}
...
pub struct VkIndirectCommandsLayoutTokenNV {
    ...
    pub vertex_dynamic_stride: vk::Bool32,
    ...
    pub p_index_types: *const VkIndexType,
    #[cdump(array(len = self.index_type_count))]
...
pub struct VkGeneratedCommandsInfoNV {
    ...
    pub sequences_count_offset: vk::DeviceSize,
    pub sequences_index_buffer: NonDisposableHandle,
    pub sequences_index_offset: vk::DeviceSize,
}
...
pub struct VkBindPipelineIndirectCommandNV {
    pub pipeline_address: vk::DeviceAddress,
}
...
pub struct VkPhysicalDeviceVariablePointersFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub variable_pointers_storage_buffer: vk::Bool32,
    pub variable_pointers: vk::Bool32,
}
...
pub struct VkPhysicalDeviceIDProperties {
    ...
    pub device_luidvalid: vk::Bool32,
}
...
pub struct VkPhysicalDeviceMultiviewFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub multiview: vk::Bool32,
    pub multiview_geometry_shader: vk::Bool32,
    pub multiview_tessellation_shader: vk::Bool32,
}
...
pub struct VkPhysicalDeviceGroupProperties {
    ...
    pub subset_allocation: vk::Bool32,
}
...
pub struct VkDisplayNativeHdrSurfaceCapabilitiesAMD {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub local_dimming_support: vk::Bool32,
}
...
pub struct VkSwapchainDisplayNativeHdrCreateInfoAMD {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub local_dimming_enable: vk::Bool32,
}
...
pub struct VkPipelineViewportWScalingStateCreateInfoNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub viewport_wscaling_enable: vk::Bool32,
    pub viewport_count: u32,
    #[cdump(array(len = self.viewport_count))]
...
pub struct VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub per_view_position_all_components: vk::Bool32,
}
...
pub struct VkPhysicalDevice16BitStorageFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub storage_buffer16_bit_access: vk::Bool32,
    pub uniform_and_storage_buffer16_bit_access: vk::Bool32,
    pub storage_push_constant16: vk::Bool32,
    pub storage_input_output16: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_subgroup_extended_types: vk::Bool32,
}
...
pub struct VkMemoryDedicatedRequirements {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub prefers_dedicated_allocation: vk::Bool32,
    pub requires_dedicated_allocation: vk::Bool32,
}
...
pub struct VkPhysicalDeviceSamplerYcbcrConversionFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub sampler_ycbcr_conversion: vk::Bool32,
}
...
pub struct VkTextureLODGatherFormatPropertiesAMD {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub supports_texture_gather_lodbias_amd: vk::Bool32,
}
...
pub struct VkProtectedSubmitInfo {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub protected_submit: vk::Bool32,
}
...
pub struct VkPhysicalDeviceProtectedMemoryFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub protected_memory: vk::Bool32,
}
...
pub struct VkPipelineCoverageToColorStateCreateInfoNV {
    ...
    pub coverage_to_color_enable: vk::Bool32,
...
pub struct VkPipelineSampleLocationsStateCreateInfoEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub sample_locations_enable: vk::Bool32,
    pub sample_locations_info: VkSampleLocationsInfoEXT,
}
...
pub struct VkPhysicalDeviceSampleLocationsPropertiesEXT {
    ...
    pub variable_sample_locations: vk::Bool32,
}
...
pub struct VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub advanced_blend_coherent_operations: vk::Bool32,
}
...
pub struct VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT {
    ...
    pub advanced_blend_independent_blend: vk::Bool32,
    pub advanced_blend_non_premultiplied_src_color: vk::Bool32,
    pub advanced_blend_non_premultiplied_dst_color: vk::Bool32,
    pub advanced_blend_correlated_overlap: vk::Bool32,
    pub advanced_blend_all_operations: vk::Bool32,
}
...
pub struct VkPipelineColorBlendAdvancedStateCreateInfoEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub src_premultiplied: vk::Bool32,
    pub dst_premultiplied: vk::Bool32,
...
pub struct VkPhysicalDeviceInlineUniformBlockFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub inline_uniform_block: vk::Bool32,
    pub descriptor_binding_inline_uniform_block_update_after_bind: vk::Bool32,
}
...
pub struct VkPipelineCoverageModulationStateCreateInfoNV {
    ...
    pub coverage_modulation_table_enable: vk::Bool32,
...
pub struct VkImageFormatListCreateInfo {
    ...
    pub p_view_formats: *const VkFormat,
}
...
pub struct VkPhysicalDeviceMaintenance5PropertiesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub early_fragment_multisample_coverage_after_sample_counting: vk::Bool32,
    pub early_fragment_sample_mask_test_before_sample_counting: vk::Bool32,
    pub depth_stencil_swizzle_one_support: vk::Bool32,
    pub polygon_mode_point_size: vk::Bool32,
    pub non_strict_single_pixel_wide_lines_use_parallelogram: vk::Bool32,
    pub non_strict_wide_lines_use_parallelogram: vk::Bool32,
}
...
pub struct VkPhysicalDeviceMaintenance6PropertiesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub block_texel_view_compatible_multiple_layers: vk::Bool32,
    pub max_combined_image_sampler_descriptor_count: u32,
    pub fragment_shading_rate_clamp_combiner_inputs: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderDrawParametersFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_draw_parameters: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderFloat16Int8Features {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_float16: vk::Bool32,
    pub shader_int8: vk::Bool32,
}
...
pub struct VkPhysicalDeviceFloatControlsProperties {
    ...
    pub shader_rounding_mode_rtefloat16: vk::Bool32,
    pub shader_rounding_mode_rtefloat32: vk::Bool32,
    pub shader_rounding_mode_rtefloat64: vk::Bool32,
    pub shader_rounding_mode_rtzfloat16: vk::Bool32,
    pub shader_rounding_mode_rtzfloat32: vk::Bool32,
    pub shader_rounding_mode_rtzfloat64: vk::Bool32,
}
...
pub struct VkPhysicalDeviceHostQueryResetFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub host_query_reset: vk::Bool32,
}
...
pub struct VkPhysicalDeviceGlobalPriorityQueryFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub global_priority_query: vk::Bool32,
}
...
pub struct VkQueueFamilyGlobalPriorityPropertiesKHR {
    ...
    pub priorities: [VkQueueGlobalPriorityKHR; vk::MAX_GLOBAL_PRIORITY_SIZE_KHR],
}
...
pub struct VkPhysicalDeviceDeviceMemoryReportFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub device_memory_report: vk::Bool32,
}
...
pub struct VkPhysicalDeviceConservativeRasterizationPropertiesEXT {
    ...
    pub primitive_underestimation: vk::Bool32,
    pub conservative_point_and_line_rasterization: vk::Bool32,
    pub degenerate_triangles_rasterized: vk::Bool32,
    pub degenerate_lines_rasterized: vk::Bool32,
    pub fully_covered_fragment_shader_input_variable: vk::Bool32,
    pub conservative_rasterization_post_depth_coverage: vk::Bool32,
}
...
pub struct VkCalibratedTimestampInfoKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub time_domain: VkTimeDomainKHR,
}
...
pub struct VkPhysicalDeviceDescriptorIndexingFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_input_attachment_array_dynamic_indexing: vk::Bool32,
    pub shader_uniform_texel_buffer_array_dynamic_indexing: vk::Bool32,
    pub shader_storage_texel_buffer_array_dynamic_indexing: vk::Bool32,
    pub shader_uniform_buffer_array_non_uniform_indexing: vk::Bool32,
    pub shader_sampled_image_array_non_uniform_indexing: vk::Bool32,
    pub shader_storage_buffer_array_non_uniform_indexing: vk::Bool32,
    pub shader_storage_image_array_non_uniform_indexing: vk::Bool32,
    pub shader_input_attachment_array_non_uniform_indexing: vk::Bool32,
    pub shader_uniform_texel_buffer_array_non_uniform_indexing: vk::Bool32,
    pub shader_storage_texel_buffer_array_non_uniform_indexing: vk::Bool32,
    pub descriptor_binding_uniform_buffer_update_after_bind: vk::Bool32,
    pub descriptor_binding_sampled_image_update_after_bind: vk::Bool32,
    pub descriptor_binding_storage_image_update_after_bind: vk::Bool32,
    pub descriptor_binding_storage_buffer_update_after_bind: vk::Bool32,
    pub descriptor_binding_uniform_texel_buffer_update_after_bind: vk::Bool32,
    pub descriptor_binding_storage_texel_buffer_update_after_bind: vk::Bool32,
    pub descriptor_binding_update_unused_while_pending: vk::Bool32,
    pub descriptor_binding_partially_bound: vk::Bool32,
    pub descriptor_binding_variable_descriptor_count: vk::Bool32,
    pub runtime_descriptor_array: vk::Bool32,
}
...
pub struct VkDescriptorSetLayoutBindingFlagsCreateInfo {
    ...
    pub binding_count: u32,
    #[cdump(array(len = self.binding_count))]
    pub p_binding_flags: *const VkDescriptorBindingFlags,
}
...
pub struct VkPhysicalDeviceTimelineSemaphoreFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub timeline_semaphore: vk::Bool32,
}
...
pub struct VkPhysicalDeviceVertexAttributeDivisorPropertiesKHR {
    ...
    pub p_next: *mut c_void,
    pub max_vertex_attrib_divisor: u32,
    pub supports_non_zero_first_instance: vk::Bool32,
}
...
pub struct VkAndroidHardwareBufferFormatPropertiesANDROID {
    ...
    pub suggested_xchroma_offset: VkChromaLocation,
    pub suggested_ychroma_offset: VkChromaLocation,
}
...
pub struct VkCommandBufferInheritanceConditionalRenderingInfoEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub conditional_rendering_enable: vk::Bool32,
}
...
pub struct VkPhysicalDevice8BitStorageFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub storage_buffer8_bit_access: vk::Bool32,
    pub uniform_and_storage_buffer8_bit_access: vk::Bool32,
    pub storage_push_constant8: vk::Bool32,
}
...
pub struct VkPhysicalDeviceConditionalRenderingFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub conditional_rendering: vk::Bool32,
    pub inherited_conditional_rendering: vk::Bool32,
}
...
pub struct VkPhysicalDeviceVulkanMemoryModelFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub vulkan_memory_model: vk::Bool32,
    pub vulkan_memory_model_device_scope: vk::Bool32,
    pub vulkan_memory_model_availability_visibility_chains: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderAtomicInt64Features {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_buffer_int64_atomics: vk::Bool32,
    pub shader_shared_int64_atomics: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderAtomicFloatFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_buffer_float32_atomics: vk::Bool32,
    pub shader_buffer_float32_atomic_add: vk::Bool32,
    pub shader_buffer_float64_atomics: vk::Bool32,
    pub shader_buffer_float64_atomic_add: vk::Bool32,
    pub shader_shared_float32_atomics: vk::Bool32,
    pub shader_shared_float32_atomic_add: vk::Bool32,
    pub shader_shared_float64_atomics: vk::Bool32,
    pub shader_shared_float64_atomic_add: vk::Bool32,
    pub shader_image_float32_atomics: vk::Bool32,
    pub shader_image_float32_atomic_add: vk::Bool32,
    pub sparse_image_float32_atomics: vk::Bool32,
    pub sparse_image_float32_atomic_add: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_buffer_float16_atomics: vk::Bool32,
    pub shader_buffer_float16_atomic_add: vk::Bool32,
    pub shader_buffer_float16_atomic_min_max: vk::Bool32,
    pub shader_buffer_float32_atomic_min_max: vk::Bool32,
    pub shader_buffer_float64_atomic_min_max: vk::Bool32,
    pub shader_shared_float16_atomics: vk::Bool32,
    pub shader_shared_float16_atomic_add: vk::Bool32,
    pub shader_shared_float16_atomic_min_max: vk::Bool32,
    pub shader_shared_float32_atomic_min_max: vk::Bool32,
    pub shader_shared_float64_atomic_min_max: vk::Bool32,
    pub shader_image_float32_atomic_min_max: vk::Bool32,
    pub sparse_image_float32_atomic_min_max: vk::Bool32,
}
...
pub struct VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub vertex_attribute_instance_rate_divisor: vk::Bool32,
    pub vertex_attribute_instance_rate_zero_divisor: vk::Bool32,
}
...
pub struct VkPhysicalDeviceASTCDecodeFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub decode_mode_shared_exponent: vk::Bool32,
}
...
pub struct VkPhysicalDeviceTransformFeedbackFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub transform_feedback: vk::Bool32,
    pub geometry_streams: vk::Bool32,
}
...
pub struct VkPhysicalDeviceTransformFeedbackPropertiesEXT {
    ...
    pub max_transform_feedback_buffer_size: vk::DeviceSize,
    ...
    pub transform_feedback_queries: vk::Bool32,
    pub transform_feedback_streams_lines_triangles: vk::Bool32,
    pub transform_feedback_rasterization_stream_select: vk::Bool32,
    pub transform_feedback_draw: vk::Bool32,
}
...
pub struct VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub representative_fragment_test: vk::Bool32,
}
...
pub struct VkPipelineRepresentativeFragmentTestStateCreateInfoNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub representative_fragment_test_enable: vk::Bool32,
}
...
pub struct VkPhysicalDeviceExclusiveScissorFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub exclusive_scissor: vk::Bool32,
}
...
pub struct VkPhysicalDeviceCornerSampledImageFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub corner_sampled_image: vk::Bool32,
}
...
pub struct VkPhysicalDeviceComputeShaderDerivativesFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub compute_derivative_group_quads: vk::Bool32,
    pub compute_derivative_group_linear: vk::Bool32,
}
...
pub struct VkPhysicalDeviceDedicatedAllocationImageAliasingFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub dedicated_allocation_image_aliasing: vk::Bool32,
}
...
pub struct VkPhysicalDeviceMemoryDecompressionFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub memory_decompression: vk::Bool32,
}
...
pub struct VkShadingRatePaletteNV {
    ...
    pub p_shading_rate_palette_entries: *const VkShadingRatePaletteEntryNV,
}
...
pub struct VkPipelineViewportShadingRateImageStateCreateInfoNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub shading_rate_image_enable: vk::Bool32,
    pub viewport_count: u32,
    #[cdump(array(len = self.viewport_count))]
...
pub struct VkPhysicalDeviceShadingRateImageFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shading_rate_image: vk::Bool32,
    pub shading_rate_coarse_sample_order: vk::Bool32,
}
...
pub struct VkPhysicalDeviceMeshShaderFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub task_shader: vk::Bool32,
    pub mesh_shader: vk::Bool32,
}
...
pub struct VkPhysicalDeviceMeshShaderFeaturesEXT {
    ...
    pub task_shader: vk::Bool32,
    pub mesh_shader: vk::Bool32,
    pub multiview_mesh_shader: vk::Bool32,
    pub primitive_fragment_shading_rate_mesh_shader: vk::Bool32,
    pub mesh_shader_queries: vk::Bool32,
}
...
pub struct VkPhysicalDeviceMeshShaderPropertiesEXT {
    ...
    pub prefers_local_invocation_vertex_output: vk::Bool32,
    pub prefers_local_invocation_primitive_output: vk::Bool32,
    pub prefers_compact_vertex_output: vk::Bool32,
    pub prefers_compact_primitive_output: vk::Bool32,
}
...
pub struct VkAccelerationStructureInfoNV {
    ...
    pub flags: vk::BuildAccelerationStructureFlagsNV,
    pub instance_count: u32,
...
pub struct VkPhysicalDeviceAccelerationStructureFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub acceleration_structure: vk::Bool32,
    pub acceleration_structure_capture_replay: vk::Bool32,
    pub acceleration_structure_indirect_build: vk::Bool32,
    pub acceleration_structure_host_commands: vk::Bool32,
    pub descriptor_binding_acceleration_structure_update_after_bind: vk::Bool32,
}
...
pub struct VkPhysicalDeviceRayTracingPipelineFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub ray_tracing_pipeline: vk::Bool32,
    pub ray_tracing_pipeline_shader_group_handle_capture_replay: vk::Bool32,
    pub ray_tracing_pipeline_shader_group_handle_capture_replay_mixed: vk::Bool32,
    pub ray_tracing_pipeline_trace_rays_indirect: vk::Bool32,
    pub ray_traversal_primitive_culling: vk::Bool32,
}
...
pub struct VkTraceRaysIndirectCommand2KHR {
    pub raygen_shader_record_address: vk::DeviceAddress,
    pub raygen_shader_record_size: vk::DeviceSize,
    pub miss_shader_binding_table_address: vk::DeviceAddress,
    pub miss_shader_binding_table_size: vk::DeviceSize,
    pub miss_shader_binding_table_stride: vk::DeviceSize,
    pub hit_shader_binding_table_address: vk::DeviceAddress,
    pub hit_shader_binding_table_size: vk::DeviceSize,
    pub hit_shader_binding_table_stride: vk::DeviceSize,
    pub callable_shader_binding_table_address: vk::DeviceAddress,
    pub callable_shader_binding_table_size: vk::DeviceSize,
    pub callable_shader_binding_table_stride: vk::DeviceSize,
    pub width: u32,
    pub height: u32,
    pub depth: u32,
}
...
pub struct VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub ray_tracing_maintenance1: vk::Bool32,
    pub ray_tracing_pipeline_trace_rays_indirect2: vk::Bool32,
}
...
pub struct VkPhysicalDeviceFragmentDensityMapFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub fragment_density_map: vk::Bool32,
    pub fragment_density_map_dynamic: vk::Bool32,
    pub fragment_density_map_non_subsampled_images: vk::Bool32,
}
...
pub struct VkPhysicalDeviceFragmentDensityMap2FeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub fragment_density_map_deferred: vk::Bool32,
}
...
pub struct VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub fragment_density_map_offset: vk::Bool32,
}
...
pub struct VkPhysicalDeviceFragmentDensityMapPropertiesEXT {
    ...
    pub fragment_density_invocations: vk::Bool32,
}
...
pub struct VkPhysicalDeviceFragmentDensityMap2PropertiesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub subsampled_loads: vk::Bool32,
    pub subsampled_coarse_reconstruction_early_access: vk::Bool32,
...
pub struct VkPhysicalDeviceScalarBlockLayoutFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub scalar_block_layout: vk::Bool32,
}
...
pub struct VkSurfaceProtectedCapabilitiesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub supports_protected: vk::Bool32,
}
...
pub struct VkPhysicalDeviceUniformBufferStandardLayoutFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub uniform_buffer_standard_layout: vk::Bool32,
}
...
pub struct VkPhysicalDeviceDepthClipEnableFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub depth_clip_enable: vk::Bool32,
}
...
pub struct VkPhysicalDevicePageableDeviceLocalMemoryFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub pageable_device_local_memory: vk::Bool32,
}
...
pub struct VkPhysicalDeviceBufferDeviceAddressFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub buffer_device_address: vk::Bool32,
    pub buffer_device_address_capture_replay: vk::Bool32,
    pub buffer_device_address_multi_device: vk::Bool32,
}
...
pub struct VkFilterCubicImageViewImageFormatPropertiesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub filter_cubic: vk::Bool32,
    pub filter_cubic_minmax: vk::Bool32,
}
...
pub struct VkPhysicalDeviceImagelessFramebufferFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub imageless_framebuffer: vk::Bool32,
}
...
pub struct VkPhysicalDeviceTextureCompressionASTCHDRFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub texture_compression_astc_hdr: vk::Bool32,
}
...
pub struct VkPhysicalDeviceCooperativeMatrixFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub cooperative_matrix: vk::Bool32,
    pub cooperative_matrix_robust_buffer_access: vk::Bool32,
}
...
pub struct VkPhysicalDeviceYcbcrImageArraysFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub ycbcr_image_arrays: vk::Bool32,
}
...
pub struct VkSurfaceCapabilitiesFullScreenExclusiveEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub full_screen_exclusive_supported: vk::Bool32,
}
...
pub struct VkSurfaceCapabilitiesPresentBarrierNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub present_barrier_supported: vk::Bool32,
}
...
pub struct VkSwapchainPresentBarrierCreateInfoNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub present_barrier_enable: vk::Bool32,
}
...
pub struct VkPhysicalDevicePerformanceQueryFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub performance_counter_query_pools: vk::Bool32,
    pub performance_counter_multiple_query_pools: vk::Bool32,
}
...
pub struct VkPhysicalDevicePerformanceQueryPropertiesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub allow_command_buffer_query_copies: vk::Bool32,
}
...
pub struct VkPhysicalDeviceCoverageReductionModeFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub coverage_reduction_mode: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderIntegerFunctions2FeaturesINTEL {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_integer_functions2: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderClockFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_subgroup_clock: vk::Bool32,
    pub shader_device_clock: vk::Bool32,
}
...
pub struct VkPhysicalDeviceIndexTypeUint8FeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub index_type_uint8: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderSMBuiltinsFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_smbuiltins: vk::Bool32,
}
...
pub struct VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub fragment_shader_sample_interlock: vk::Bool32,
    pub fragment_shader_pixel_interlock: vk::Bool32,
    pub fragment_shader_shading_rate_interlock: vk::Bool32,
}
...
pub struct VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub separate_depth_stencil_layouts: vk::Bool32,
}
...
pub struct VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub primitive_topology_list_restart: vk::Bool32,
    pub primitive_topology_patch_list_restart: vk::Bool32,
}
...
pub struct VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub pipeline_executable_info: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_demote_to_helper_invocation: vk::Bool32,
}
...
pub struct VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub texel_buffer_alignment: vk::Bool32,
}
...
pub struct VkPhysicalDeviceSubgroupSizeControlFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub subgroup_size_control: vk::Bool32,
    pub compute_full_subgroups: vk::Bool32,
}
...
pub struct VkPhysicalDeviceClusterCullingShaderPropertiesHUAWEI {
    ...
    pub indirect_buffer_offset_alignment: vk::DeviceSize,
}
...
pub struct VkPhysicalDeviceLineRasterizationFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub rectangular_lines: vk::Bool32,
    pub bresenham_lines: vk::Bool32,
    pub smooth_lines: vk::Bool32,
    pub stippled_rectangular_lines: vk::Bool32,
    pub stippled_bresenham_lines: vk::Bool32,
    pub stippled_smooth_lines: vk::Bool32,
}
...
pub struct VkPipelineRasterizationLineStateCreateInfoKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub line_rasterization_mode: VkLineRasterizationModeKHR,
    pub stippled_line_enable: vk::Bool32,
...
pub struct VkPhysicalDevicePipelineCreationCacheControlFeatures {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub pipeline_creation_cache_control: vk::Bool32,
}
...
pub struct VkPhysicalDeviceVulkan12Features {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub sampler_mirror_clamp_to_edge: vk::Bool32,
    pub draw_indirect_count: vk::Bool32,
    pub storage_buffer8_bit_access: vk::Bool32,
    pub uniform_and_storage_buffer8_bit_access: vk::Bool32,
    pub storage_push_constant8: vk::Bool32,
    pub shader_buffer_int64_atomics: vk::Bool32,
    ...
    pub shader_float16: vk::Bool32,
    pub shader_int8: vk::Bool32,
    pub descriptor_indexing: vk::Bool32,
    pub shader_input_attachment_array_dynamic_indexing: vk::Bool32,
    pub shader_uniform_texel_buffer_array_dynamic_indexing: vk::Bool32,
    pub shader_storage_texel_buffer_array_dynamic_indexing: vk::Bool32,
    pub shader_uniform_buffer_array_non_uniform_indexing: vk::Bool32,
    ...
    pub descriptor_binding_variable_descriptor_count: vk::Bool32,
    pub runtime_descriptor_array: vk::Bool32,
    pub sampler_filter_minmax: vk::Bool32,
    pub scalar_block_layout: vk::Bool32,
    pub imageless_framebuffer: vk::Bool32,
    pub uniform_buffer_standard_layout: vk::Bool32,
    pub shader_subgroup_extended_types: vk::Bool32,
    ...
    pub vulkan_memory_model_device_scope: vk::Bool32,
    pub vulkan_memory_model_availability_visibility_chains: vk::Bool32,
    pub shader_output_viewport_index: vk::Bool32,
    pub shader_output_layer: vk::Bool32,
    pub subgroup_broadcast_dynamic_id: vk::Bool32,
}
...
pub struct VkPhysicalDeviceVulkan13Features {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub robust_image_access: vk::Bool32,
    pub inline_uniform_block: vk::Bool32,
    pub descriptor_binding_inline_uniform_block_update_after_bind: vk::Bool32,
    pub pipeline_creation_cache_control: vk::Bool32,
    pub private_data: vk::Bool32,
    pub shader_demote_to_helper_invocation: vk::Bool32,
    pub shader_terminate_invocation: vk::Bool32,
    pub subgroup_size_control: vk::Bool32,
    pub compute_full_subgroups: vk::Bool32,
    pub synchronization2: vk::Bool32,
    pub texture_compression_astc_hdr: vk::Bool32,
    pub shader_zero_initialize_workgroup_memory: vk::Bool32,
    pub dynamic_rendering: vk::Bool32,
    pub shader_integer_dot_product: vk::Bool32,
    pub maintenance4: vk::Bool32,
}
...
pub struct VkPhysicalDeviceVulkan13Properties {
    ...
    pub integer_dot_product_accumulating_saturating4x8_bit_packed_mixed_signedness_accelerated: vk::Bool32,
...
pub struct VkPhysicalDeviceCoherentMemoryFeaturesAMD {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub device_coherent_memory: vk::Bool32,
}
...
pub struct VkPhysicalDeviceCustomBorderColorFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub custom_border_colors: vk::Bool32,
    pub custom_border_color_without_format: vk::Bool32,
}
...
pub struct VkPhysicalDeviceBorderColorSwizzleFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub border_color_swizzle: vk::Bool32,
    pub border_color_swizzle_from_image: vk::Bool32,
}
...
pub struct VkAccelerationStructureGeometryInstancesDataKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub array_of_pointers: vk::Bool32,
    pub data: VkDeviceOrHostAddressConstKHR,
}
...
pub struct VkPhysicalDeviceExtendedDynamicStateFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub extended_dynamic_state: vk::Bool32,
}
...
pub struct VkPhysicalDeviceExtendedDynamicState2FeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub extended_dynamic_state2: vk::Bool32,
    pub extended_dynamic_state2_logic_op: vk::Bool32,
    pub extended_dynamic_state2_patch_control_points: vk::Bool32,
}
...
pub struct VkPhysicalDeviceExtendedDynamicState3FeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub extended_dynamic_state3_tessellation_domain_origin: vk::Bool32,
    pub extended_dynamic_state3_depth_clamp_enable: vk::Bool32,
    pub extended_dynamic_state3_polygon_mode: vk::Bool32,
    pub extended_dynamic_state3_rasterization_samples: vk::Bool32,
    pub extended_dynamic_state3_sample_mask: vk::Bool32,
    pub extended_dynamic_state3_alpha_to_coverage_enable: vk::Bool32,
    pub extended_dynamic_state3_alpha_to_one_enable: vk::Bool32,
    pub extended_dynamic_state3_logic_op_enable: vk::Bool32,
    pub extended_dynamic_state3_color_blend_enable: vk::Bool32,
    pub extended_dynamic_state3_color_blend_equation: vk::Bool32,
    pub extended_dynamic_state3_color_write_mask: vk::Bool32,
    pub extended_dynamic_state3_rasterization_stream: vk::Bool32,
    pub extended_dynamic_state3_conservative_rasterization_mode: vk::Bool32,
    pub extended_dynamic_state3_extra_primitive_overestimation_size: vk::Bool32,
    pub extended_dynamic_state3_depth_clip_enable: vk::Bool32,
    pub extended_dynamic_state3_sample_locations_enable: vk::Bool32,
    pub extended_dynamic_state3_color_blend_advanced: vk::Bool32,
    pub extended_dynamic_state3_provoking_vertex_mode: vk::Bool32,
    pub extended_dynamic_state3_line_rasterization_mode: vk::Bool32,
    pub extended_dynamic_state3_line_stipple_enable: vk::Bool32,
    pub extended_dynamic_state3_depth_clip_negative_one_to_one: vk::Bool32,
    pub extended_dynamic_state3_viewport_wscaling_enable: vk::Bool32,
    pub extended_dynamic_state3_viewport_swizzle: vk::Bool32,
    pub extended_dynamic_state3_coverage_to_color_enable: vk::Bool32,
    pub extended_dynamic_state3_coverage_to_color_location: vk::Bool32,
    pub extended_dynamic_state3_coverage_modulation_mode: vk::Bool32,
    pub extended_dynamic_state3_coverage_modulation_table_enable: vk::Bool32,
    pub extended_dynamic_state3_coverage_modulation_table: vk::Bool32,
    pub extended_dynamic_state3_coverage_reduction_mode: vk::Bool32,
    pub extended_dynamic_state3_representative_fragment_test_enable: vk::Bool32,
    pub extended_dynamic_state3_shading_rate_image_enable: vk::Bool32,
}
...
pub struct VkPhysicalDeviceExtendedDynamicState3PropertiesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub dynamic_primitive_topology_unrestricted: vk::Bool32,
}
...
pub struct VkPhysicalDeviceDiagnosticsConfigFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub diagnostics_config: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_subgroup_uniform_control_flow: vk::Bool32,
}
...
pub struct VkPhysicalDeviceRobustness2FeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub robust_buffer_access2: vk::Bool32,
    pub robust_image_access2: vk::Bool32,
    pub null_descriptor: vk::Bool32,
}
...
pub struct VkPhysicalDeviceRobustness2PropertiesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub robust_storage_buffer_access_size_alignment: vk::DeviceSize,
    pub robust_uniform_buffer_access_size_alignment: vk::DeviceSize,
}
...
pub struct VkPhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub workgroup_memory_explicit_layout: vk::Bool32,
    pub workgroup_memory_explicit_layout_scalar_block_layout: vk::Bool32,
    pub workgroup_memory_explicit_layout8_bit_access: vk::Bool32,
    pub workgroup_memory_explicit_layout16_bit_access: vk::Bool32,
}
...
pub struct VkPhysicalDevicePortabilitySubsetFeaturesKHR {
    ...
    pub image_view2_don3_dimage: vk::Bool32,
...
pub struct VkPhysicalDevice4444FormatsFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub format_a4_r4_g4_b4: vk::Bool32,
    pub format_a4_b4_g4_r4: vk::Bool32,
}
...
pub struct VkPhysicalDeviceClusterCullingShaderFeaturesHUAWEI {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub clusterculling_shader: vk::Bool32,
    pub multiview_cluster_culling_shader: vk::Bool32,
}
...
pub struct VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub cluster_shading_rate: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_image_int64_atomics: vk::Bool32,
    pub sparse_image_int64_atomics: vk::Bool32,
}
...
pub struct VkPhysicalDeviceFragmentShadingRateFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub pipeline_fragment_shading_rate: vk::Bool32,
    pub primitive_fragment_shading_rate: vk::Bool32,
    pub attachment_fragment_shading_rate: vk::Bool32,
}
...
pub struct VkPhysicalDeviceFragmentShadingRatePropertiesKHR {
    ...
    pub primitive_fragment_shading_rate_with_multiple_viewports: vk::Bool32,
    pub layered_shading_rate_attachments: vk::Bool32,
    pub fragment_shading_rate_non_trivial_combiner_ops: vk::Bool32,
    ...
    pub fragment_shading_rate_with_shader_depth_stencil_writes: vk::Bool32,
    pub fragment_shading_rate_with_sample_mask: vk::Bool32,
    pub fragment_shading_rate_with_shader_sample_mask: vk::Bool32,
    pub fragment_shading_rate_with_conservative_rasterization: vk::Bool32,
    pub fragment_shading_rate_with_fragment_shader_interlock: vk::Bool32,
    pub fragment_shading_rate_with_custom_sample_locations: vk::Bool32,
    pub fragment_shading_rate_strict_multiply_combiner: vk::Bool32,
}
...
pub struct VkPhysicalDeviceFragmentShadingRateEnumsFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub fragment_shading_rate_enums: vk::Bool32,
    pub supersample_fragment_shading_rates: vk::Bool32,
    pub no_invocation_fragment_shading_rates: vk::Bool32,
}
...
pub struct VkPhysicalDeviceImage2DViewOf3DFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub image2_dview_of3_d: vk::Bool32,
    pub sampler2_dview_of3_d: vk::Bool32,
}
...
pub struct VkPhysicalDeviceImageSlicedViewOf3DFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub image_sliced_view_of3_d: vk::Bool32,
}
...
pub struct VkPhysicalDeviceAttachmentFeedbackLoopDynamicStateFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub attachment_feedback_loop_dynamic_state: vk::Bool32,
}
...
pub struct VkPhysicalDeviceMutableDescriptorTypeFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub mutable_descriptor_type: vk::Bool32,
}
...
pub struct VkMutableDescriptorTypeListEXT {
    ...
    pub p_descriptor_types: *const VkDescriptorType,
}
...
pub struct VkPhysicalDeviceDepthClipControlFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub depth_clip_control: vk::Bool32,
}
...
pub struct VkPipelineViewportDepthClipControlCreateInfoEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub negative_one_to_one: vk::Bool32,
}
...
pub struct VkPhysicalDeviceVertexInputDynamicStateFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub vertex_input_dynamic_state: vk::Bool32,
}
...
pub struct VkPhysicalDeviceExternalMemoryRDMAFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub external_memory_rdma: vk::Bool32,
}
...
pub struct VkPhysicalDeviceColorWriteEnableFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub color_write_enable: vk::Bool32,
}
...
pub struct VkPipelineColorWriteCreateInfoEXT {
    ...
    pub attachment_count: u32,
    #[cdump(array(len = self.attachment_count))]
    pub p_color_write_enables: *const vk::Bool32,
}
...
pub struct VkPhysicalDeviceHostImageCopyPropertiesEXT {
    ...
    pub p_copy_src_layouts: *mut VkImageLayout,
    pub copy_dst_layout_count: u32,
    #[cdump(array(len = self.copy_dst_layout_count))]
    pub p_copy_dst_layouts: *mut VkImageLayout,
    pub optimal_tiling_layout_uuid: [u8; vk::UUID_SIZE],
    pub identical_memory_type_requirements: vk::Bool32,
}
...
pub struct VkHostImageCopyDevicePerformanceQueryEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub optimal_device_access: vk::Bool32,
    pub identical_memory_layout: vk::Bool32,
}
...
pub struct VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub primitives_generated_query: vk::Bool32,
    pub primitives_generated_query_with_rasterizer_discard: vk::Bool32,
    pub primitives_generated_query_with_non_zero_streams: vk::Bool32,
}
...
pub struct VkPhysicalDeviceLegacyDitheringFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub legacy_dithering: vk::Bool32,
}
...
pub struct VkPhysicalDeviceMultisampledRenderToSingleSampledFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub multisampled_render_to_single_sampled: vk::Bool32,
}
...
pub struct VkMultisampledRenderToSingleSampledInfoEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub multisampled_render_to_single_sampled_enable: vk::Bool32,
    pub rasterization_samples: vk::SampleCountFlags,
}
...
pub struct VkPhysicalDevicePipelineProtectedAccessFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub pipeline_protected_access: vk::Bool32,
}
...
pub struct VkQueueFamilyQueryResultStatusPropertiesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub query_result_status_support: vk::Bool32,
}
...
pub struct VkVideoCapabilitiesKHR {
    ...
    pub min_bitstream_buffer_offset_alignment: vk::DeviceSize,
    pub min_bitstream_buffer_size_alignment: vk::DeviceSize,
...
pub struct VkVideoDecodeInfoKHR {
    ...
    pub src_buffer: NonDisposableHandle,
    pub src_buffer_offset: vk::DeviceSize,
    pub src_buffer_range: vk::DeviceSize,
...
pub struct VkPhysicalDeviceVideoMaintenance1FeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub video_maintenance1: vk::Bool32,
}
...
pub struct VkVideoDecodeAV1ProfileInfoKHR {
    ...
    pub film_grain_support: vk::Bool32,
}
...
pub struct VkVideoEncodeUsageInfoKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub video_usage_hints: VkVideoEncodeUsageFlagsKHR,
    pub video_content_hints: VkVideoEncodeContentFlagsKHR,
    pub tuning_mode: VkVideoEncodeTuningModeKHR,
}
...
pub struct VkVideoEncodeInfoKHR {
    ...
    pub dst_buffer: NonDisposableHandle,
    pub dst_buffer_offset: vk::DeviceSize,
    pub dst_buffer_range: vk::DeviceSize,
...
pub struct VkVideoEncodeQualityLevelPropertiesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub preferred_rate_control_mode: VkVideoEncodeRateControlModeFlagBitsKHR,
...
pub struct VkVideoEncodeRateControlInfoKHR {
    ...
    pub rate_control_mode: VkVideoEncodeRateControlModeFlagBitsKHR,
    pub layer_count: u32,
...
pub struct VkVideoEncodeCapabilitiesKHR {
    ...
    pub rate_control_modes: VkVideoEncodeRateControlModeFlagsKHR,
    pub max_rate_control_layers: u32,
    pub max_bitrate: u64,
    pub max_quality_levels: u32,
    pub encode_input_picture_granularity: VkExtent2D,
    pub supported_encode_feedback_flags: VkVideoEncodeFeedbackFlagsKHR,
}
...
pub struct VkVideoEncodeH264CapabilitiesKHR {
    ...
    pub expect_dyadic_temporal_layer_pattern: vk::Bool32,
    pub min_qp: i32,
    pub max_qp: i32,
    pub prefers_gop_remaining_frames: vk::Bool32,
    pub requires_gop_remaining_frames: vk::Bool32,
    pub std_syntax_flags: VkVideoEncodeH264StdFlagsKHR,
}
...
pub struct VkVideoEncodeH264QualityLevelPropertiesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub preferred_rate_control_flags: VkVideoEncodeH264RateControlFlagsKHR,
    ...
    pub preferred_std_entropy_coding_mode_flag: vk::Bool32,
}
...
pub struct VkVideoEncodeH264SessionCreateInfoKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub use_max_level_idc: vk::Bool32,
    pub max_level_idc: vk::native::StdVideoH264LevelIdc,
}
...
pub struct VkVideoEncodeH264SessionParametersGetInfoKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub write_std_sps: vk::Bool32,
    pub write_std_pps: vk::Bool32,
    pub std_spsid: u32,
    pub std_ppsid: u32,
}
...
pub struct VkVideoEncodeH264SessionParametersFeedbackInfoKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub has_std_spsoverrides: vk::Bool32,
    pub has_std_ppsoverrides: vk::Bool32,
}
...
pub struct VkVideoEncodeH264PictureInfoKHR {
    ...
    pub generate_prefix_nalu: vk::Bool32,
}
...
pub struct VkVideoEncodeH264RateControlLayerInfoKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub use_min_qp: vk::Bool32,
    pub min_qp: VkVideoEncodeH264QpKHR,
    pub use_max_qp: vk::Bool32,
...
pub struct VkVideoEncodeH265CapabilitiesKHR {
    ...
    pub ctb_sizes: VkVideoEncodeH265CtbSizeFlagsKHR,
    pub transform_block_sizes: VkVideoEncodeH265TransformBlockSizeFlagsKHR,
    pub max_ppicture_l0_reference_count: u32,
    pub max_bpicture_l0_reference_count: u32,
    pub max_l1_reference_count: u32,
    pub max_sub_layer_count: u32,
    pub expect_dyadic_temporal_sub_layer_pattern: vk::Bool32,
    pub min_qp: i32,
    pub max_qp: i32,
    pub prefers_gop_remaining_frames: vk::Bool32,
    pub requires_gop_remaining_frames: vk::Bool32,
    pub std_syntax_flags: VkVideoEncodeH265StdFlagsKHR,
}
...
pub struct VkVideoEncodeH265QualityLevelPropertiesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub preferred_rate_control_flags: VkVideoEncodeH265RateControlFlagsKHR,
    pub preferred_gop_frame_count: u32,
    pub preferred_idr_period: u32,
    pub preferred_consecutive_bframe_count: u32,
...
pub struct VkVideoEncodeH265SessionParametersFeedbackInfoKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub has_std_vpsoverrides: vk::Bool32,
    pub has_std_spsoverrides: vk::Bool32,
    pub has_std_ppsoverrides: vk::Bool32,
}
...
pub struct VkPhysicalDeviceInheritedViewportScissorFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub inherited_viewport_scissor2_d: vk::Bool32,
}
...
pub struct VkCommandBufferInheritanceViewportScissorInfoNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub viewport_scissor2_d: vk::Bool32,
...
pub struct VkPhysicalDeviceYcbcr2Plane444FormatsFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub ycbcr2plane444_formats: vk::Bool32,
}
...
pub struct VkPhysicalDeviceProvokingVertexFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub provoking_vertex_last: vk::Bool32,
    pub transform_feedback_preserves_provoking_vertex: vk::Bool32,
}
...
pub struct VkPhysicalDeviceProvokingVertexPropertiesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub provoking_vertex_mode_per_pipeline: vk::Bool32,
    pub transform_feedback_preserves_triangle_fan_provoking_vertex: vk::Bool32,
}
...
pub struct VkPhysicalDeviceDescriptorBufferFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub descriptor_buffer: vk::Bool32,
    pub descriptor_buffer_capture_replay: vk::Bool32,
    pub descriptor_buffer_image_layout_ignored: vk::Bool32,
    pub descriptor_buffer_push_descriptors: vk::Bool32,
}
...
pub struct VkPhysicalDeviceDescriptorBufferPropertiesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub combined_image_sampler_descriptor_single_array: vk::Bool32,
    pub bufferless_push_descriptors: vk::Bool32,
    pub allow_sampler_image_view_post_submit_creation: vk::Bool32,
    ...
    pub max_sampler_descriptor_buffer_range: vk::DeviceSize,
    pub max_resource_descriptor_buffer_range: vk::DeviceSize,
    pub sampler_descriptor_buffer_address_space_size: vk::DeviceSize,
    pub resource_descriptor_buffer_address_space_size: vk::DeviceSize,
    pub descriptor_buffer_address_space_size: vk::DeviceSize,
}
...
pub struct VkPhysicalDeviceDrmPropertiesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub has_primary: vk::Bool32,
    pub has_render: vk::Bool32,
...
pub struct VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub fragment_shader_barycentric: vk::Bool32,
}
...
pub struct VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub tri_strip_vertex_order_independent_of_provoking_vertex: vk::Bool32,
}
...
pub struct VkPhysicalDeviceRayTracingMotionBlurFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub ray_tracing_motion_blur: vk::Bool32,
    pub ray_tracing_motion_blur_pipeline_trace_rays_indirect: vk::Bool32,
}
...
pub struct VkPhysicalDeviceRayTracingValidationFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub ray_tracing_validation: vk::Bool32,
}
...
pub struct VkPhysicalDeviceRGBA10X6FormatsFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub format_rgba10x6_without_ycb_cr_sampler: vk::Bool32,
}
...
pub struct VkMultiviewPerViewAttributesInfoNVX {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub per_view_attributes: vk::Bool32,
    pub per_view_attributes_position_xonly: vk::Bool32,
}
...
pub struct VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub rasterization_order_color_attachment_access: vk::Bool32,
    pub rasterization_order_depth_attachment_access: vk::Bool32,
    pub rasterization_order_stencil_attachment_access: vk::Bool32,
}
...
pub struct VkPhysicalDeviceLinearColorAttachmentFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub linear_color_attachment: vk::Bool32,
}
...
pub struct VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub graphics_pipeline_library: vk::Bool32,
}
...
pub struct VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub graphics_pipeline_library_fast_linking: vk::Bool32,
    pub graphics_pipeline_library_independent_interpolation_decoration: vk::Bool32,
}
...
pub struct VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVE {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub descriptor_set_host_mapping: vk::Bool32,
}
...
pub struct VkPhysicalDeviceNestedCommandBufferFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub nested_command_buffer: vk::Bool32,
    pub nested_command_buffer_rendering: vk::Bool32,
    pub nested_command_buffer_simultaneous_use: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderModuleIdentifierFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_module_identifier: vk::Bool32,
}
...
pub struct VkImageCompressionControlEXT {
    ...
    pub p_fixed_rate_flags: *mut VkImageCompressionFixedRateFlagsEXT,
}
...
pub struct VkPhysicalDeviceImageCompressionControlFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub image_compression_control: vk::Bool32,
}
...
pub struct VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub image_compression_control_swapchain: vk::Bool32,
}
...
pub struct VkRenderPassCreationControlEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub disallow_merging: vk::Bool32,
}
...
pub struct VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub subpass_merge_feedback: vk::Bool32,
}
...
pub struct VkPhysicalDeviceOpacityMicromapFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub micromap: vk::Bool32,
    pub micromap_capture_replay: vk::Bool32,
    pub micromap_host_commands: vk::Bool32,
}
...
pub struct VkPhysicalDeviceDisplacementMicromapFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub displacement_micromap: vk::Bool32,
}
...
pub struct VkAccelerationStructureTrianglesDisplacementMicromapNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub displacement_bias_and_scale_format: VkFormat,
    pub displacement_vector_format: VkFormat,
    pub displacement_bias_and_scale_buffer: VkDeviceOrHostAddressConstKHR,
    pub displacement_bias_and_scale_stride: vk::DeviceSize,
    pub displacement_vector_buffer: VkDeviceOrHostAddressConstKHR,
    pub displacement_vector_stride: vk::DeviceSize,
    pub displaced_micromap_primitive_flags: VkDeviceOrHostAddressConstKHR,
    pub displaced_micromap_primitive_flags_stride: vk::DeviceSize,
    pub index_type: VkIndexType,
    pub index_buffer: VkDeviceOrHostAddressConstKHR,
    pub index_stride: vk::DeviceSize,
    pub base_triangle: u32,
...
pub struct VkPhysicalDevicePipelinePropertiesFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub pipeline_properties_identifier: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_early_and_late_fragment_tests: vk::Bool32,
}
...
pub struct VkExternalMemoryAcquireUnmodifiedEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub acquire_unmodified_memory: vk::Bool32,
}
...
pub struct VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub non_seamless_cube_map: vk::Bool32,
}
...
pub struct VkPhysicalDevicePipelineRobustnessFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub pipeline_robustness: vk::Bool32,
}
...
pub struct VkPhysicalDeviceImageProcessingFeaturesQCOM {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub texture_sample_weighted: vk::Bool32,
    pub texture_box_filter: vk::Bool32,
    pub texture_block_match: vk::Bool32,
}
...
pub struct VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub attachment_feedback_loop_layout: vk::Bool32,
}
...
pub struct VkPhysicalDeviceDepthClampZeroOneFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub depth_clamp_zero_one: vk::Bool32,
}
...
pub struct VkPhysicalDeviceAddressBindingReportFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub report_address_binding: vk::Bool32,
}
...
pub struct VkPhysicalDeviceOpticalFlowPropertiesNV {
    ...
    pub hint_supported: vk::Bool32,
    pub cost_supported: vk::Bool32,
    pub bidirectional_flow_supported: vk::Bool32,
    pub global_flow_supported: vk::Bool32,
    pub min_width: u32,
    pub min_height: u32,
    pub max_width: u32,
    pub max_height: u32,
...
pub struct VkPhysicalDeviceFaultFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub device_fault: vk::Bool32,
    pub device_fault_vendor_binary: vk::Bool32,
}
...
pub struct VkDeviceFaultAddressInfoEXT {
    ...
    pub reported_address: vk::DeviceAddress,
    pub address_precision: vk::DeviceSize,
}
...
pub struct VkDeviceFaultCountsEXT {
    ...
    pub vendor_binary_size: vk::DeviceSize,
}
...
pub struct VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub pipeline_library_group_handles: vk::Bool32,
}
...
pub struct VkDepthBiasRepresentationInfoEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub depth_bias_representation: VkDepthBiasRepresentationEXT,
    pub depth_bias_exact: vk::Bool32,
}
...
pub struct VkDecompressMemoryRegionNV {
    pub src_address: vk::DeviceAddress,
    pub dst_address: vk::DeviceAddress,
    pub compressed_size: vk::DeviceSize,
    pub decompressed_size: vk::DeviceSize,
...
pub struct VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_core_builtins: vk::Bool32,
}
...
pub struct VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub dynamic_rendering_unused_attachments: vk::Bool32,
}
...
pub struct VkSurfacePresentModeCompatibilityEXT {
    ...
    pub p_present_modes: *mut VkPresentModeKHR,
}
...
pub struct VkPhysicalDeviceSwapchainMaintenance1FeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub swapchain_maintenance1: vk::Bool32,
}
...
pub struct VkSwapchainPresentModesCreateInfoEXT {
    ...
    pub present_mode_count: u32,
    #[cdump(array(len = self.present_mode_count))]
    pub p_present_modes: *const VkPresentModeKHR,
}
...
pub struct VkPhysicalDeviceDepthBiasControlFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub depth_bias_control: vk::Bool32,
    pub least_representable_value_force_unorm_representation: vk::Bool32,
    pub float_representation: vk::Bool32,
    pub depth_bias_exact: vk::Bool32,
}
...
pub struct VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub ray_tracing_invocation_reorder: vk::Bool32,
}
...
pub struct VkPhysicalDeviceExtendedSparseAddressSpaceFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub extended_sparse_address_space: vk::Bool32,
}
...
pub struct VkPhysicalDeviceExtendedSparseAddressSpacePropertiesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub extended_sparse_address_space_size: vk::DeviceSize,
    pub extended_sparse_image_usage_flags: VkImageUsageFlags,
    pub extended_sparse_buffer_usage_flags: VkBufferUsageFlags,
}
...
pub struct VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub multiview_per_view_viewports: vk::Bool32,
}
...
pub struct VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub ray_tracing_position_fetch: vk::Bool32,
}
...
pub struct VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub multiview_per_view_render_areas: vk::Bool32,
}
...
pub struct VkShaderCreateInfoEXT {
    ...
    pub stage: vk::ShaderStageFlags,
    pub next_stage: VkShaderStageFlags,
    pub code_type: VkShaderCodeTypeEXT,
    pub code_size: usize,
...
pub struct VkPhysicalDeviceShaderTileImageFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_tile_image_color_read_access: vk::Bool32,
    pub shader_tile_image_depth_read_access: vk::Bool32,
    pub shader_tile_image_stencil_read_access: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderTileImagePropertiesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_tile_image_coherent_read_accelerated: vk::Bool32,
    pub shader_tile_image_read_sample_from_pixel_rate_invocation: vk::Bool32,
    pub shader_tile_image_read_from_helper_invocation: vk::Bool32,
}
...
pub struct VkPhysicalDeviceExternalMemoryScreenBufferFeaturesQNX {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub screen_buffer_import: vk::Bool32,
}
...
pub struct VkCooperativeMatrixPropertiesKHR {
    ...
    pub n_size: u32,
    pub k_size: u32,
    pub a_type: VkComponentTypeKHR,
    pub b_type: VkComponentTypeKHR,
    pub c_type: VkComponentTypeKHR,
    pub result_type: VkComponentTypeKHR,
...
pub struct VkSetDescriptorBufferOffsetsInfoEXT {
    ...
    #[cdump(array(len = self.set_count))]
    pub p_offsets: *const vk::DeviceSize,
}
...
pub struct VkPhysicalDeviceCubicClampFeaturesQCOM {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub cubic_range_clamp: vk::Bool32,
}
...
pub struct VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub enable_ydegamma: vk::Bool32,
    pub enable_cb_cr_degamma: vk::Bool32,
}
...
pub struct VkPhysicalDeviceCubicWeightsFeaturesQCOM {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub selectable_cubic_weights: vk::Bool32,
}
...
pub struct VkSamplerCubicWeightsCreateInfoQCOM {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub cubic_weights: VkCubicFilterWeightsQCOM,
}
...
pub struct VkPhysicalDeviceImageProcessing2FeaturesQCOM {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub texture_block_match2: vk::Bool32,
}
...
pub struct VkSamplerBlockMatchWindowCreateInfoQCOM {
    ...
    pub window_compare_mode: VkBlockMatchWindowCompareModeQCOM,
}
...
pub struct VkPhysicalDeviceDescriptorPoolOverallocationFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub descriptor_pool_overallocation: vk::Bool32,
}
...
pub struct VkPhysicalDeviceLayeredDriverPropertiesMSFT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub underlying_api: VkLayeredDriverUnderlyingApiMSFT,
}
...
pub struct VkPhysicalDevicePerStageDescriptorSetFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub per_stage_descriptor_set: vk::Bool32,
    pub dynamic_pipeline_layout: vk::Bool32,
}
...
pub struct VkPhysicalDeviceExternalFormatResolveFeaturesANDROID {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub external_format_resolve: vk::Bool32,
}
...
pub struct VkPhysicalDeviceExternalFormatResolvePropertiesANDROID {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub null_color_attachment_with_external_format_resolve: vk::Bool32,
    pub external_format_resolve_chroma_offset_x: VkChromaLocation,
    pub external_format_resolve_chroma_offset_y: VkChromaLocation,
}
...
pub struct VkLatencySleepModeInfoNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub low_latency_mode: vk::Bool32,
    pub low_latency_boost: vk::Bool32,
...
pub struct VkOutOfBandQueueTypeInfoNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub queue_type: VkOutOfBandQueueTypeNV,
}
...
pub struct VkSwapchainLatencyCreateInfoNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *const c_void,
    pub latency_mode_enable: vk::Bool32,
}
...
pub struct VkPhysicalDeviceCudaKernelLaunchFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub cuda_kernel_launch_features: vk::Bool32,
}
...
pub struct VkPhysicalDeviceSchedulingControlsFeaturesARM {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub scheduling_controls: vk::Bool32,
}
...
pub struct VkPhysicalDeviceSchedulingControlsPropertiesARM {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub scheduling_controls_flags: VkPhysicalDeviceSchedulingControlsFlagsARM,
}
...
pub struct VkPhysicalDeviceRelaxedLineRasterizationFeaturesIMG {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub relaxed_line_rasterization: vk::Bool32,
}
...
pub struct VkPhysicalDeviceRenderPassStripedFeaturesARM {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub render_pass_striped: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderMaximalReconvergenceFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_maximal_reconvergence: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderSubgroupRotateFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_subgroup_rotate: vk::Bool32,
    pub shader_subgroup_rotate_clustered: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderExpectAssumeFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_expect_assume: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderFloatControls2FeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_float_controls2: vk::Bool32,
}
...
pub struct VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub dynamic_rendering_local_read: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderQuadControlFeaturesKHR {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_quad_control: vk::Bool32,
}
...
pub struct VkPhysicalDeviceShaderAtomicFloat16VectorFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_float16_vector_atomics: vk::Bool32,
}
...
pub struct VkPhysicalDeviceMapMemoryPlacedFeaturesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub memory_map_placed: vk::Bool32,
    pub memory_map_range_placed: vk::Bool32,
    pub memory_unmap_reserve: vk::Bool32,
}
...
pub struct VkPhysicalDeviceMapMemoryPlacedPropertiesEXT {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub min_placed_memory_map_alignment: vk::DeviceSize,
}
...
pub struct VkPhysicalDeviceRawAccessChainsFeaturesNV {
    ...
    #[cdump(dynamic(serializer = p_next_serializer, deserializer = p_next_deserializer, cdebugger = p_next_cdebugger))]
    pub p_next: *mut c_void,
    pub shader_raw_access_chains: vk::Bool32,
}
...
pub struct StdVideoAV1LoopRestoration {
    pub frame_restoration_type: [vk::native::StdVideoAV1FrameRestorationType; STD_VIDEO_AV1_MAX_NUM_PLANES],

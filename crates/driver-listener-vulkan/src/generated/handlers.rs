...
fn vk_enumerate_physical_devices(mut packet: Packet) {
    let instance: vk::Instance = packet.read();
    let (p_physical_device_count, p_physical_devices) = packet.read_and_allocate_vk_array_count::<vk::PhysicalDevice>();
...
fn vk_get_physical_device_queue_family_properties(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let (p_queue_family_property_count, p_queue_family_properties) = packet.read_and_allocate_vk_array_count::<vk::QueueFamilyProperties>();
...
fn vk_enumerate_instance_layer_properties(mut packet: Packet) {
    let (p_property_count, p_properties) = packet.read_and_allocate_vk_array_count::<vk::LayerProperties>();
...
fn vk_enumerate_instance_extension_properties(mut packet: Packet) {
    ...
    let (p_property_count, p_properties) = packet.read_and_allocate_vk_array_count::<vk::ExtensionProperties>();
...
fn vk_get_image_sparse_memory_requirements(mut packet: Packet) {
    let device: vk::Device = packet.read();
    let image: vk::Image = packet.read();
    let (p_sparse_memory_requirement_count, p_sparse_memory_requirements) = packet.read_and_allocate_vk_array_count::<vk::SparseImageMemoryRequirements>();
...
fn vk_get_physical_device_sparse_image_format_properties(mut packet: Packet) {
    ...
    let usage: vk::ImageUsageFlags = packet.read();
    let tiling: vk::ImageTiling = packet.read();
    let (p_property_count, p_properties) = packet.read_and_allocate_vk_array_count::<vk::SparseImageFormatProperties>();
...
fn vk_get_physical_device_display_properties_khr(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let (p_property_count, p_properties) = packet.read_and_allocate_vk_array_count::<vk::DisplayPropertiesKHR>();
...
fn vk_get_physical_device_display_plane_properties_khr(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let (p_property_count, p_properties) = packet.read_and_allocate_vk_array_count::<vk::DisplayPlanePropertiesKHR>();
...
fn vk_get_display_mode_properties_khr(mut packet: Packet) {
    ...
    let (p_property_count, p_properties) = packet.read_and_allocate_vk_array_count::<vk::DisplayModePropertiesKHR>();
...
fn vk_get_physical_device_surface_formats_khr(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let surface: vk::SurfaceKHR = packet.read();
    let (p_surface_format_count, p_surface_formats) = packet.read_and_allocate_vk_array_count::<vk::SurfaceFormatKHR>();
...
fn vk_get_physical_device_surface_present_modes_khr(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let surface: vk::SurfaceKHR = packet.read();
    let (p_present_mode_count, p_present_modes) = packet.read_and_allocate_vk_array_count::<vk::PresentModeKHR>();
...
fn vk_get_swapchain_images_khr(mut packet: Packet) {
    let device: vk::Device = packet.read();
    let swapchain: vk::SwapchainKHR = packet.read();
    let (p_swapchain_image_count, p_swapchain_images) = packet.read_and_allocate_vk_array_count::<vk::Image>();
...
fn vk_get_physical_device_queue_family_properties2(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let (p_queue_family_property_count, p_queue_family_properties) = packet.read_and_allocate_vk_array_count::<vk::QueueFamilyProperties2>();
...
fn vk_get_physical_device_sparse_image_format_properties2(mut packet: Packet) {
    ...
    let (p_property_count, p_properties) = packet.read_and_allocate_vk_array_count::<vk::SparseImageFormatProperties2>();
...
fn vk_enumerate_physical_device_groups(mut packet: Packet) {
    let instance: vk::Instance = packet.read();
    let (p_physical_device_group_count, p_physical_device_group_properties) = packet.read_and_allocate_vk_array_count::<vk::PhysicalDeviceGroupProperties>();
...
fn vk_get_past_presentation_timing_google(mut packet: Packet) {
    let device: vk::Device = packet.read();
    let swapchain: vk::SwapchainKHR = packet.read();
    let (p_presentation_timing_count, p_presentation_timings) = packet.read_and_allocate_vk_array_count::<vk::PastPresentationTimingGOOGLE>();
...
fn vk_get_physical_device_surface_formats2_khr(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let p_surface_info: *const vk::PhysicalDeviceSurfaceInfo2KHR = packet.read();
    let (p_surface_format_count, p_surface_formats) = packet.read_and_allocate_vk_array_count::<vk::SurfaceFormat2KHR>();
...
fn vk_get_physical_device_display_properties2_khr(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let (p_property_count, p_properties) = packet.read_and_allocate_vk_array_count::<vk::DisplayProperties2KHR>();
...
fn vk_get_physical_device_display_plane_properties2_khr(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let (p_property_count, p_properties) = packet.read_and_allocate_vk_array_count::<vk::DisplayPlaneProperties2KHR>();
...
fn vk_get_display_mode_properties2_khr(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let display: vk::DisplayKHR = packet.read();
    let (p_property_count, p_properties) = packet.read_and_allocate_vk_array_count::<vk::DisplayModeProperties2KHR>();
...
fn vk_get_image_sparse_memory_requirements2(mut packet: Packet) {
    ...
    let (p_sparse_memory_requirement_count, p_sparse_memory_requirements) = packet.read_and_allocate_vk_array_count::<vk::SparseImageMemoryRequirements2>();
...
fn vk_get_physical_device_calibrateable_time_domains_khr(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let (p_time_domain_count, p_time_domains) = packet.read_and_allocate_vk_array_count::<vk::TimeDomainKHR>();
...
fn vk_get_queue_checkpoint_data_nv(mut packet: Packet) {
    let queue: vk::Queue = packet.read();
    let (p_checkpoint_data_count, p_checkpoint_data) = packet.read_and_allocate_vk_array_count::<vk::CheckpointDataNV>();
...
fn vk_get_physical_device_cooperative_matrix_properties_nv(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let (p_property_count, p_properties) = packet.read_and_allocate_vk_array_count::<vk::CooperativeMatrixPropertiesNV>();
...
fn vk_enumerate_physical_device_queue_family_performance_query_counters_khr(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let queue_family_index: u32 = packet.read();
    let (p_counter_count, p_counters) = packet.read_and_allocate_vk_array_count::<vk::PerformanceCounterKHR>();
...
fn vk_get_physical_device_supported_framebuffer_mixed_samples_combinations_nv(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let (p_combination_count, p_combinations) = packet.read_and_allocate_vk_array_count::<vk::FramebufferMixedSamplesCombinationNV>();
...
fn vk_get_pipeline_executable_properties_khr(mut packet: Packet) {
    ...
    let (p_executable_count, p_properties) = packet.read_and_allocate_vk_array_count::<vk::PipelineExecutablePropertiesKHR>();
...
fn vk_get_pipeline_executable_statistics_khr(mut packet: Packet) {
    ...
    let (p_statistic_count, p_statistics) = packet.read_and_allocate_vk_array_count::<vk::PipelineExecutableStatisticKHR>();
...
fn vk_get_pipeline_executable_internal_representations_khr(mut packet: Packet) {
    let device: vk::Device = packet.read();
    let p_executable_info: *const vk::PipelineExecutableInfoKHR = packet.read();
    let (p_internal_representation_count, p_internal_representations) = packet.read_and_allocate_vk_array_count::<vk::PipelineExecutableInternalRepresentationKHR>();
...
fn vk_get_physical_device_tool_properties(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let (p_tool_count, p_tool_properties) = packet.read_and_allocate_vk_array_count::<vk::PhysicalDeviceToolProperties>();
...
fn vk_get_physical_device_fragment_shading_rates_khr(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let (p_fragment_shading_rate_count, p_fragment_shading_rates) = packet.read_and_allocate_vk_array_count::<vk::PhysicalDeviceFragmentShadingRateKHR>();
...
fn vk_get_queue_checkpoint_data2_nv(mut packet: Packet) {
    let queue: vk::Queue = packet.read();
    let (p_checkpoint_data_count, p_checkpoint_data) = packet.read_and_allocate_vk_array_count::<vk::CheckpointData2NV>();
...
fn vk_get_physical_device_video_format_properties_khr(mut packet: Packet) {
    ...
    let (p_video_format_property_count, p_video_format_properties) = packet.read_and_allocate_vk_array_count::<vk::VideoFormatPropertiesKHR>();
...
fn vk_get_video_session_memory_requirements_khr(mut packet: Packet) {
    let device: vk::Device = packet.read();
    let video_session: vk::VideoSessionKHR = packet.read();
    let (p_memory_requirements_count, p_memory_requirements) = packet.read_and_allocate_vk_array_count::<vk::VideoSessionMemoryRequirementsKHR>();
...
fn vk_get_framebuffer_tile_properties_qcom(mut packet: Packet) {
    let device: vk::Device = packet.read();
    let framebuffer: vk::Framebuffer = packet.read();
    let (p_properties_count, p_properties) = packet.read_and_allocate_vk_array_count::<vk::TilePropertiesQCOM>();
...
fn vk_get_physical_device_optical_flow_image_formats_nv(mut packet: Packet) {
    ...
    let (p_format_count, p_image_format_properties) = packet.read_and_allocate_vk_array_count::<vk::OpticalFlowImageFormatPropertiesNV>();
...
fn vk_get_physical_device_cooperative_matrix_properties_khr(mut packet: Packet) {
    let physical_device: vk::PhysicalDevice = packet.read();
    let (p_property_count, p_properties) = packet.read_and_allocate_vk_array_count::<vk::CooperativeMatrixPropertiesKHR>();

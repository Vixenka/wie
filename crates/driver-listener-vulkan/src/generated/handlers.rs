...
fn vk_create_instance(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_create_info),
            to_reference(p_allocator),
            to_reference(p_instance)
        );
    }
...
fn vk_enumerate_physical_devices(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_physical_devices)
        );
    }
...
fn vk_get_physical_device_queue_family_properties(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_queue_family_properties)
        );
    }
...
fn vk_get_physical_device_memory_properties(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            to_reference(p_memory_properties)
        );
    }
...
fn vk_get_physical_device_format_properties(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            format,
            to_reference(p_format_properties)
        );
    }
...
fn vk_get_physical_device_image_format_properties(mut packet: Packet) {
    ...
    unsafe {
        trace!("called vkGetPhysicalDeviceImageFormatProperties({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?})", physical_device, format, type_, tiling, usage, flags, to_reference(p_image_format_properties));
    }
...
fn vk_allocate_memory(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_allocate_info),
            to_reference(p_allocator),
            to_reference(p_memory)
        );
    }
...
fn vk_get_device_memory_commitment(mut packet: Packet) {
    let device: NonDisposableHandle = packet.read_shallow();
    let memory: NonDisposableHandle = packet.read_shallow();
    let p_committed_memory_in_bytes: *mut NonDisposableHandle =
    ...
    unsafe {
        trace!(
            ...
            device,
            memory,
            to_reference(p_committed_memory_in_bytes)
        );
    }
...
fn vk_get_buffer_memory_requirements(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            buffer,
            to_reference(p_memory_requirements)
        );
    }
...
fn vk_get_image_sparse_memory_requirements(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_sparse_memory_requirements)
        );
    }
...
fn vk_get_physical_device_sparse_image_format_properties(mut packet: Packet) {
    ...
    unsafe {
        trace!("called vkGetPhysicalDeviceSparseImageFormatProperties({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?})", physical_device, format, type_, samples, usage, tiling, p_property_count, to_reference(p_properties));
    }
...
fn vk_get_image_subresource_layout(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            image,
            to_reference(p_subresource),
            to_reference(p_layout)
        );
    }
...
fn vk_create_graphics_pipelines(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            pipeline_cache,
            create_info_count,
            to_reference(p_create_infos),
            to_reference(p_allocator),
            to_reference(p_pipelines)
        );
    }
...
fn vk_get_device_subpass_shading_max_workgroup_size_huawei(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            renderpass,
            to_reference(p_max_workgroup_size)
        );
    }
...
fn vk_create_pipeline_layout(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_create_info),
            to_reference(p_allocator),
            to_reference(p_pipeline_layout)
        );
    }
...
fn vk_create_descriptor_pool(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_create_info),
            to_reference(p_allocator),
            to_reference(p_descriptor_pool)
        );
    }
...
fn vk_allocate_descriptor_sets(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_allocate_info),
            to_reference(p_descriptor_sets)
        );
    }
...
fn vk_update_descriptor_sets(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_descriptor_writes),
            descriptor_copy_count,
            to_reference(p_descriptor_copies)
        );
    }
...
fn vk_get_rendering_area_granularity_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_rendering_area_info),
            to_reference(p_granularity)
        );
    }
...
fn vk_allocate_command_buffers(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_allocate_info),
            to_reference(p_command_buffers)
        );
    }
...
fn vk_cmd_bind_descriptor_sets(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_dynamic_offsets)
        );
    }
...
fn vk_cmd_bind_vertex_buffers(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            first_binding,
            binding_count,
            to_reference(p_buffers),
            to_reference(p_offsets)
        );
    }
...
fn vk_cmd_draw_multi_indexed_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            draw_count,
            to_reference(p_index_info),
            instance_count,
            first_instance,
            stride,
            to_reference(p_vertex_offset)
        );
    }
...
fn vk_cmd_copy_memory_to_image_indirect_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            dst_image,
            dst_image_layout,
            to_reference(p_image_subresources)
        );
    }
...
fn vk_cmd_clear_color_image(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            image,
            image_layout,
            to_reference(p_color),
            range_count,
            to_reference(p_ranges)
        );
    }
...
fn vk_cmd_clear_attachments(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            attachment_count,
            to_reference(p_attachments),
            rect_count,
            to_reference(p_rects)
        );
    }
...
fn vk_cmd_wait_events(mut packet: Packet) {
    ...
    unsafe {
        trace!("called vkCmdWaitEvents({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?})", command_buffer, event_count, to_reference(p_events), src_stage_mask, dst_stage_mask, memory_barrier_count, to_reference(p_memory_barriers), buffer_memory_barrier_count, to_reference(p_buffer_memory_barriers), image_memory_barrier_count, to_reference(p_image_memory_barriers));
    }
...
fn vk_cmd_pipeline_barrier(mut packet: Packet) {
    ...
    let p_image_memory_barriers: *const VkImageMemoryBarrier = packet.read_deep();
    unsafe {
        trace!("called vkCmdPipelineBarrier({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?})", command_buffer, src_stage_mask, dst_stage_mask, dependency_flags, memory_barrier_count, to_reference(p_memory_barriers), buffer_memory_barrier_count, to_reference(p_buffer_memory_barriers), image_memory_barrier_count, to_reference(p_image_memory_barriers));
    }
...
fn vk_cmd_begin_conditional_rendering_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_conditional_rendering_begin)
        );
    }
...
fn vk_cmd_begin_render_pass(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_render_pass_begin),
            contents
        );
    }
...
fn vk_get_physical_device_surface_capabilities_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            surface,
            to_reference(p_surface_capabilities)
        );
    }
...
fn vk_get_physical_device_surface_formats_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_surface_formats)
        );
    }
...
fn vk_get_swapchain_images_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_swapchain_images)
        );
    }
...
fn vk_debug_report_message_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            location,
            message_code,
            to_reference(p_layer_prefix),
            to_reference(p_message)
        );
    }
...
fn vk_get_physical_device_external_image_format_properties_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!("called vkGetPhysicalDeviceExternalImageFormatPropertiesNV({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?})", physical_device, format, type_, tiling, usage, flags, external_handle_type, to_reference(p_external_image_format_properties));
    }
...
fn vk_cmd_execute_generated_commands_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            is_preprocessed,
            to_reference(p_generated_commands_info)
        );
    }
...
fn vk_create_indirect_commands_layout_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_create_info),
            to_reference(p_allocator),
            to_reference(p_indirect_commands_layout)
        );
    }
...
fn vk_get_physical_device_image_format_properties2(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            to_reference(p_image_format_info),
            to_reference(p_image_format_properties)
        );
    }
...
fn vk_get_physical_device_external_buffer_properties(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            to_reference(p_external_buffer_info),
            to_reference(p_external_buffer_properties)
        );
    }
...
fn vk_get_memory_win32_handle_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_get_win32_handle_info),
            to_reference(p_handle)
        );
    }
...
fn vk_get_memory_win32_handle_properties_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            handle_type,
            handle,
            to_reference(p_memory_win32_handle_properties)
        );
    }
...
fn vk_get_memory_fd_properties_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            handle_type,
            fd,
            to_reference(p_memory_fd_properties)
        );
    }
...
fn vk_get_memory_zircon_handle_fuchsia(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_get_zircon_handle_info),
            to_reference(p_zircon_handle)
        );
    }
...
fn vk_get_memory_zircon_handle_properties_fuchsia(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            handle_type,
            zircon_handle,
            to_reference(p_memory_zircon_handle_properties)
        );
    }
...
fn vk_get_memory_remote_address_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_memory_get_remote_address_info),
            to_reference(p_address)
        );
    }
...
fn vk_get_physical_device_external_semaphore_properties(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            to_reference(p_external_semaphore_info),
            to_reference(p_external_semaphore_properties)
        );
    }
...
fn vk_import_semaphore_win32_handle_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_import_semaphore_win32_handle_info)
        );
    }
...
fn vk_import_semaphore_fd_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_import_semaphore_fd_info)
        );
    }
...
fn vk_import_semaphore_zircon_handle_fuchsia(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_import_semaphore_zircon_handle_info)
        );
    }
...
fn vk_get_physical_device_external_fence_properties(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            to_reference(p_external_fence_info),
            to_reference(p_external_fence_properties)
        );
    }
...
fn vk_import_fence_win32_handle_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_import_fence_win32_handle_info)
        );
    }
...
fn vk_import_fence_fd_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_import_fence_fd_info)
        );
    }
...
fn vk_display_power_control_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            display,
            to_reference(p_display_power_info)
        );
    }
...
fn vk_register_device_event_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_device_event_info),
            to_reference(p_allocator),
            to_reference(p_fence)
        );
    }
...
fn vk_register_display_event_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            display,
            to_reference(p_display_event_info),
            to_reference(p_allocator),
            to_reference(p_fence)
        );
    }
...
fn vk_enumerate_physical_device_groups(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_physical_device_group_properties)
        );
    }
...
fn vk_get_device_group_peer_memory_features(mut packet: Packet) {
    ...
    let p_peer_memory_features: *mut NonDisposableHandle =
        packet.read_mut_shallow_under_nullable_ptr();
    unsafe {
        trace!(
            ...
            local_device_index,
            remote_device_index,
            to_reference(p_peer_memory_features)
        );
    }
...
fn vk_get_device_group_present_capabilities_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_device_group_present_capabilities)
        );
    }
...
fn vk_create_descriptor_update_template(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_create_info),
            to_reference(p_allocator),
            to_reference(p_descriptor_update_template)
        );
    }
...
fn vk_get_refresh_cycle_duration_google(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            swapchain,
            to_reference(p_display_timing_properties)
        );
    }
...
fn vk_get_past_presentation_timing_google(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_presentation_timings)
        );
    }
...
fn vk_cmd_set_viewport_wscaling_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            first_viewport,
            viewport_count,
            to_reference(p_viewport_wscalings)
        );
    }
...
fn vk_cmd_set_discard_rectangle_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_discard_rectangles)
        );
    }
...
fn vk_cmd_set_sample_locations_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_sample_locations_info)
        );
    }
...
fn vk_get_physical_device_multisample_properties_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            samples,
            to_reference(p_multisample_properties)
        );
    }
...
fn vk_get_display_plane_capabilities2_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            to_reference(p_display_plane_info),
            to_reference(p_capabilities)
        );
    }
...
fn vk_create_sampler_ycbcr_conversion(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_create_info),
            to_reference(p_allocator),
            to_reference(p_ycbcr_conversion)
        );
    }
...
fn vk_create_validation_cache_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_create_info),
            to_reference(p_allocator),
            to_reference(p_validation_cache)
        );
    }
...
fn vk_get_swapchain_gralloc_usage2_android(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(gralloc_consumer_usage),
            to_reference(gralloc_producer_usage)
        );
    }
...
fn vk_queue_signal_release_image_android(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_wait_semaphores),
            image,
            to_reference(p_native_fence_fd)
        );
    }
...
fn vk_get_calibrated_timestamps_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            timestamp_count,
            to_reference(p_timestamp_infos),
            to_reference(p_timestamps),
            to_reference(p_max_deviation)
        );
    }
...
fn vk_get_memory_host_pointer_properties_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            handle_type,
            to_reference(p_host_pointer),
            to_reference(p_memory_host_pointer_properties)
        );
    }
...
fn vk_cmd_begin_render_pass2(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_render_pass_begin),
            to_reference(p_subpass_begin_info)
        );
    }
...
fn vk_cmd_next_subpass2(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_subpass_begin_info),
            to_reference(p_subpass_end_info)
        );
    }
...
fn vk_cmd_set_checkpoint_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_checkpoint_marker)
        );
    }
...
fn vk_get_queue_checkpoint_data_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_checkpoint_data)
        );
    }
...
fn vk_cmd_begin_transform_feedback_ext(mut packet: Packet) {
    ...
    let p_counter_buffer_offsets: *const NonDisposableHandle =
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_counter_buffers),
            to_reference(p_counter_buffer_offsets)
        );
    }
...
fn vk_cmd_set_exclusive_scissor_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_exclusive_scissors)
        );
    }
...
fn vk_cmd_set_exclusive_scissor_enable_nv(mut packet: Packet) {
    ...
    let first_exclusive_scissor: u32 = packet.read_shallow();
    let exclusive_scissor_count: u32 = packet.read_shallow();
    let p_exclusive_scissor_enables: *const NonDisposableHandle =
        packet.read_shallow_under_nullable_ptr();
    unsafe {
        trace!(
            ...
            first_exclusive_scissor,
            exclusive_scissor_count,
            to_reference(p_exclusive_scissor_enables)
        );
    }
...
fn vk_cmd_set_viewport_shading_rate_palette_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            first_viewport,
            viewport_count,
            to_reference(p_shading_rate_palettes)
        );
    }
...
fn vk_cmd_set_coarse_sample_order_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_custom_sample_orders)
        );
    }
...
fn vk_create_acceleration_structure_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_create_info),
            to_reference(p_allocator),
            to_reference(p_acceleration_structure)
        );
    }
...
fn vk_get_acceleration_structure_memory_requirements_nv(mut packet: Packet) {
    ...
    let p_memory_requirements: *mut NonDisposableHandle =
        packet.read_mut_shallow_under_nullable_ptr();
    unsafe {
        trace!(
...
fn vk_cmd_write_acceleration_structures_properties_khr(mut packet: Packet) {
    ...
    let first_query: u32 = packet.read_shallow();
    unsafe {
        trace!("called vkCmdWriteAccelerationStructuresPropertiesKHR({:?}, {:?}, {:?}, {:?}, {:?}, {:?})", command_buffer, acceleration_structure_count, to_reference(p_acceleration_structures), query_type, query_pool, first_query);
    }
...
fn vk_cmd_write_acceleration_structures_properties_nv(mut packet: Packet) {
    ...
    let first_query: u32 = packet.read_shallow();
    unsafe {
        trace!("called vkCmdWriteAccelerationStructuresPropertiesNV({:?}, {:?}, {:?}, {:?}, {:?}, {:?})", command_buffer, acceleration_structure_count, to_reference(p_acceleration_structures), query_type, query_pool, first_query);
    }
...
fn vk_cmd_build_acceleration_structure_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!("called vkCmdBuildAccelerationStructureNV({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?})", command_buffer, to_reference(p_info), instance_data, instance_offset, update, dst, src, scratch, scratch_offset);
    }
...
fn vk_write_acceleration_structures_properties_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!("called vkWriteAccelerationStructuresPropertiesKHR({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?})", device, acceleration_structure_count, to_reference(p_acceleration_structures), query_type, data_size, to_reference(p_data), stride);
    }
...
fn vk_cmd_trace_rays_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_raygen_shader_binding_table),
            to_reference(p_miss_shader_binding_table),
            to_reference(p_hit_shader_binding_table),
            to_reference(p_callable_shader_binding_table),
            width,
            height,
            depth
        );
...
fn vk_get_ray_tracing_capture_replay_shader_group_handles_khr(mut packet: Packet) {
    ...
    let p_data: *mut c_void = packet.read_mut_shallow_under_nullable_ptr();
    unsafe {
        trace!("called vkGetRayTracingCaptureReplayShaderGroupHandlesKHR({:?}, {:?}, {:?}, {:?}, {:?}, {:?})", device, pipeline, first_group, group_count, data_size, to_reference(p_data));
    }
...
fn vk_get_device_acceleration_structure_compatibility_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_version_info),
            to_reference(p_compatibility)
        );
    }
...
fn vk_enumerate_physical_device_queue_family_performance_query_counters_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!("called vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR({:?}, {:?}, {:?}, {:?}, {:?})", physical_device, queue_family_index, p_counter_count, to_reference(p_counters), to_reference(p_counter_descriptions));
    }
...
fn vk_get_physical_device_queue_family_performance_query_passes_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            to_reference(p_performance_query_create_info),
            to_reference(p_num_passes)
        );
    }
...
fn vk_get_physical_device_supported_framebuffer_mixed_samples_combinations_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!("called vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV({:?}, {:?}, {:?})", physical_device, p_combination_count, to_reference(p_combinations));
    }
...
fn vk_initialize_performance_api_intel(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_initialize_info)
        );
    }
...
fn vk_get_pipeline_executable_statistics_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_executable_info),
            p_statistic_count,
            to_reference(p_statistics)
        );
    }
...
fn vk_get_pipeline_executable_internal_representations_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_internal_representations)
        );
    }
...
fn vk_get_physical_device_tool_properties(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            p_tool_count,
            to_reference(p_tool_properties)
        );
    }
...
fn vk_cmd_build_acceleration_structures_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            info_count,
            to_reference(p_infos),
            to_reference(pp_build_range_infos)
        );
    }
...
fn vk_cmd_build_acceleration_structures_indirect_khr(mut packet: Packet) {
    ...
    let info_count: u32 = packet.read_shallow();
    let p_infos: *const VkAccelerationStructureBuildGeometryInfoKHR = packet.read_deep();
    let p_indirect_device_addresses: *const NonDisposableHandle =
        packet.read_shallow_under_nullable_ptr();
    ...
    unsafe {
        trace!("called vkCmdBuildAccelerationStructuresIndirectKHR({:?}, {:?}, {:?}, {:?}, {:?}, {:?})", command_buffer, info_count, to_reference(p_infos), to_reference(p_indirect_device_addresses), to_reference(p_indirect_strides), to_reference(pp_max_primitive_counts));
    }
...
fn vk_create_deferred_operation_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_allocator),
            to_reference(p_deferred_operation)
        );
    }
...
fn vk_cmd_set_color_blend_enable_ext(mut packet: Packet) {
    ...
    let attachment_count: u32 = packet.read_shallow();
    let p_color_blend_enables: *const NonDisposableHandle =
        packet.read_shallow_under_nullable_ptr();
    unsafe {
        trace!(
            ...
            first_attachment,
            attachment_count,
            to_reference(p_color_blend_enables)
        );
    }
...
fn vk_cmd_set_color_blend_equation_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            first_attachment,
            attachment_count,
            to_reference(p_color_blend_equations)
        );
    }
...
fn vk_cmd_set_color_write_mask_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            first_attachment,
            attachment_count,
            to_reference(p_color_write_masks)
        );
    }
...
fn vk_cmd_set_color_blend_advanced_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            first_attachment,
            attachment_count,
            to_reference(p_color_blend_advanced)
        );
    }
...
fn vk_cmd_set_viewport_swizzle_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            first_viewport,
            viewport_count,
            to_reference(p_viewport_swizzles)
        );
    }
...
fn vk_cmd_set_coverage_modulation_table_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_coverage_modulation_table)
        );
    }
...
fn vk_create_private_data_slot(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_create_info),
            to_reference(p_allocator),
            to_reference(p_private_data_slot)
        );
    }
...
fn vk_cmd_copy_buffer2(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_copy_buffer_info)
        );
    }
...
fn vk_cmd_copy_image2(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_copy_image_info)
        );
    }
...
fn vk_cmd_blit_image2(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_blit_image_info)
        );
    }
...
fn vk_cmd_copy_buffer_to_image2(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_copy_buffer_to_image_info)
        );
    }
...
fn vk_cmd_copy_image_to_buffer2(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_copy_image_to_buffer_info)
        );
    }
...
fn vk_cmd_resolve_image2(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_resolve_image_info)
        );
    }
...
fn vk_get_physical_device_fragment_shading_rates_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_fragment_shading_rates)
        );
    }
...
fn vk_get_acceleration_structure_build_sizes_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            build_type,
            to_reference(p_build_info),
            to_reference(p_max_primitive_counts),
            to_reference(p_size_info)
        );
    }
...
fn vk_cmd_set_vertex_input_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_vertex_binding_descriptions),
            vertex_attribute_description_count,
            to_reference(p_vertex_attribute_descriptions)
        );
    }
...
fn vk_cmd_set_color_write_enable_ext(mut packet: Packet) {
    let command_buffer: NonDisposableHandle = packet.read_shallow();
    let attachment_count: u32 = packet.read_shallow();
    let p_color_write_enables: *const NonDisposableHandle =
        packet.read_shallow_under_nullable_ptr();
    unsafe {
        trace!(
            ...
            command_buffer,
            attachment_count,
            to_reference(p_color_write_enables)
        );
    }
...
fn vk_cmd_set_event2(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            event,
            to_reference(p_dependency_info)
        );
    }
...
fn vk_cmd_wait_events2(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            event_count,
            to_reference(p_events),
            to_reference(p_dependency_infos)
        );
    }
...
fn vk_copy_memory_to_image_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_copy_memory_to_image_info)
        );
    }
...
fn vk_copy_image_to_memory_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_copy_image_to_memory_info)
        );
    }
...
fn vk_copy_image_to_image_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_copy_image_to_image_info)
        );
    }
...
fn vk_get_physical_device_video_format_properties_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            to_reference(p_video_format_info),
            p_video_format_property_count,
            to_reference(p_video_format_properties)
        );
    }
...
fn vk_get_physical_device_video_encode_quality_level_properties_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            to_reference(p_quality_level_info),
            to_reference(p_quality_level_properties)
        );
    }
...
fn vk_create_video_session_parameters_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_create_info),
            to_reference(p_allocator),
            to_reference(p_video_session_parameters)
        );
    }
...
fn vk_get_encoded_video_session_parameters_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_video_session_parameters_info),
            to_reference(p_feedback_info),
            to_reference(p_data_size),
            to_reference(p_data)
        );
    }
...
fn vk_bind_video_session_memory_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_bind_session_memory_infos)
        );
    }
...
fn vk_cmd_control_video_coding_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_coding_control_info)
        );
    }
...
fn vk_cmd_end_video_coding_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_end_coding_info)
        );
    }
...
fn vk_cmd_decompress_memory_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            to_reference(p_decompress_memory_regions)
        );
    }
...
fn vk_get_descriptor_set_layout_size_ext(mut packet: Packet) {
    let device: NonDisposableHandle = packet.read_shallow();
    let layout: NonDisposableHandle = packet.read_shallow();
    let p_layout_size_in_bytes: *mut NonDisposableHandle =
        packet.read_mut_shallow_under_nullable_ptr();
    unsafe {
        trace!(
            ...
            device,
            layout,
            to_reference(p_layout_size_in_bytes)
        );
    }
...
fn vk_get_descriptor_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_descriptor_info),
            data_size,
            to_reference(p_descriptor)
        );
    }
...
fn vk_set_buffer_collection_buffer_constraints_fuchsia(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            collection,
            to_reference(p_buffer_constraints_info)
        );
    }
...
fn vk_set_buffer_collection_image_constraints_fuchsia(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            collection,
            to_reference(p_image_constraints_info)
        );
    }
...
fn vk_get_cuda_module_cache_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            module,
            to_reference(p_cache_size),
            to_reference(p_cache_data)
        );
    }
...
fn vk_get_descriptor_set_layout_host_mapping_info_valve(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_binding_reference),
            to_reference(p_host_mapping)
        );
    }
...
fn vk_get_pipeline_properties_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_pipeline_info),
            to_reference(p_pipeline_properties)
        );
    }
...
fn vk_export_metal_objects_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_metal_objects_info)
        );
    }
...
fn vk_get_physical_device_optical_flow_image_formats_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            physical_device,
            to_reference(p_optical_flow_image_format_info),
            p_format_count,
            to_reference(p_image_format_properties)
        );
    }
...
fn vk_get_device_fault_info_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_fault_counts),
            to_reference(p_fault_info)
        );
    }
...
fn vk_cmd_set_depth_bias2_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_depth_bias_info)
        );
    }
...
fn vk_map_memory2_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_memory_map_info),
            to_reference(pp_data)
        );
    }
...
fn vk_unmap_memory2_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            to_reference(p_memory_unmap_info)
        );
    }
...
fn vk_get_execution_graph_pipeline_node_index_amdx(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            execution_graph,
            to_reference(p_node_info),
            to_reference(p_node_index)
        );
    }
...
fn vk_cmd_bind_descriptor_sets2_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_bind_descriptor_sets_info)
        );
    }
...
fn vk_cmd_push_constants2_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_push_constants_info)
        );
    }
...
fn vk_cmd_push_descriptor_set2_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_push_descriptor_set_info)
        );
    }
...
fn vk_cmd_push_descriptor_set_with_template2_khr(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_push_descriptor_set_with_template_info)
        );
    }
...
fn vk_cmd_set_descriptor_buffer_offsets2_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_set_descriptor_buffer_offsets_info)
        );
    }
...
fn vk_cmd_bind_descriptor_buffer_embedded_samplers2_ext(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            command_buffer,
            to_reference(p_bind_descriptor_buffer_embedded_samplers_info)
        );
    }
...
fn vk_set_latency_sleep_mode_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            swapchain,
            to_reference(p_sleep_mode_info)
        );
    }
...
fn vk_set_latency_marker_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            device,
            swapchain,
            to_reference(p_latency_marker_info)
        );
    }
...
fn vk_queue_notify_out_of_band_nv(mut packet: Packet) {
    ...
    unsafe {
        trace!(
            ...
            queue,
            to_reference(p_queue_type_info)
        );
    }

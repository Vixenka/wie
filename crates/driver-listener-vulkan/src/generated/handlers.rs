...
fn vk_destroy_device(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_destroy_device)(device, p_allocator) };
}
...
fn vk_unmap_memory(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_unmap_memory)(device, memory) };
}
...
fn vk_destroy_semaphore(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_destroy_semaphore)(device, semaphore, p_allocator) };
}
...
fn vk_destroy_pipeline(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_destroy_pipeline)(device, pipeline, p_allocator) };
}
...
fn vk_cmd_set_line_width(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_set_line_width)(command_buffer, line_width) };
}
...
fn vk_cmd_set_event(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_set_event)(command_buffer, event, stage_mask) };
}
...
fn vk_cmd_end_query(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_end_query)(command_buffer, query_pool, query) };
}
...
fn vk_cmd_end_conditional_rendering_ext(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_end_conditional_rendering_ext)(command_buffer) };
}
...
fn vk_cmd_end_render_pass(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_end_render_pass)(command_buffer) };
}
...
fn vk_get_display_plane_supported_displays_khr(mut packet: Packet) {
    ...
    let (mut p_display_count, p_displays) =
        packet.read_and_allocate_vk_array_count::<vk::DisplayKHR>();
...
fn vk_trim_command_pool(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_trim_command_pool)(device, command_pool, flags) };
}
...
fn vk_cmd_set_device_mask(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_set_device_mask)(command_buffer, device_mask) };
}
...
fn vk_get_device_queue2(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_get_device_queue2)(device, p_queue_info, p_queue) };
...
fn vk_release_profiling_lock_khr(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_release_profiling_lock_khr)(device) };
}
...
fn vk_cmd_build_acceleration_structures_khr(mut packet: Packet) {
    ...
    let pp_build_range_infos: *const *const vk::AccelerationStructureBuildRangeInfoKHR =
        packet.read();
...
fn vk_cmd_set_front_face(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_set_front_face)(command_buffer, front_face) };
}
...
fn vk_cmd_set_logic_op_ext(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_set_logic_op_ext)(command_buffer, logic_op) };
}
...
fn vk_cmd_set_vertex_input_ext(mut packet: Packet) {
    ...
    let p_vertex_attribute_descriptions: *const vk::VertexInputAttributeDescription2EXT =
        packet.read();
...
fn vk_cmd_end_rendering(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_end_rendering)(command_buffer) };
}
...
fn vk_destroy_shader_ext(mut packet: Packet) {
    ...
    unsafe { (crate::FUNCTION_ADDRESS_TABLE.vk_destroy_shader_ext)(device, shader, p_allocator) };
}

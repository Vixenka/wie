...
fn vk_destroy_instance(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_destroy_instance)(instance, p_allocator);
    }
}
...
fn vk_enumerate_physical_devices(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_enumerate_physical_devices)(
            instance,
            p_physical_device_count as *mut _,
            p_physical_devices,
        );
    }
}
...
fn vk_get_device_proc_addr(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_device_proc_addr)(device, p_name);
    }
}
...
fn vk_get_instance_proc_addr(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_instance_proc_addr)(instance, p_name);
    }
}
...
fn vk_get_physical_device_queue_family_properties(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_physical_device_queue_family_properties)(
            physical_device,
            p_queue_family_property_count as *mut _,
...
fn vk_destroy_device(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_destroy_device)(device, p_allocator);
    }
}
...
fn vk_enumerate_instance_version(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_enumerate_instance_version)(p_api_version);
    }
}
...
fn vk_queue_wait_idle(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_queue_wait_idle)(queue);
    }
}
...
fn vk_device_wait_idle(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_device_wait_idle)(device);
    }
}
...
fn vk_free_memory(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_free_memory)(device, memory, p_allocator);
    }
}
...
fn vk_unmap_memory(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_unmap_memory)(device, memory);
    }
}
...
fn vk_get_image_sparse_memory_requirements(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_image_sparse_memory_requirements)(
            device,
            image,
            p_sparse_memory_requirement_count as *mut _,
...
fn vk_destroy_fence(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_destroy_fence)(device, fence, p_allocator);
    }
}
...
fn vk_reset_fences(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_reset_fences)(device, fence_count, p_fences);
    }
}
...
fn vk_get_fence_status(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_fence_status)(device, fence);
    }
}
...
fn vk_destroy_event(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_destroy_event)(device, event, p_allocator);
    }
}
...
fn vk_get_event_status(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_event_status)(device, event);
    }
}
...
fn vk_set_event(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_set_event)(device, event);
    }
}
...
fn vk_reset_event(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_reset_event)(device, event);
    }
}
...
fn vk_destroy_buffer(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_destroy_buffer)(device, buffer, p_allocator);
    }
}
...
fn vk_destroy_image(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_destroy_image)(device, image, p_allocator);
    }
}
...
fn vk_destroy_sampler(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_destroy_sampler)(device, sampler, p_allocator);
    }
}
...
fn vk_end_command_buffer(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_end_command_buffer)(command_buffer);
    }
}
...
fn vk_reset_command_buffer(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_reset_command_buffer)(command_buffer, flags);
    }
}
...
fn vk_cmd_subpass_shading_huawei(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_subpass_shading_huawei)(command_buffer);
    }
}
...
fn vk_cmd_next_subpass(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_next_subpass)(command_buffer, contents);
    }
}
...
fn vk_cmd_end_render_pass(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_end_render_pass)(command_buffer);
    }
}
...
fn vk_get_physical_device_surface_formats_khr(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_physical_device_surface_formats_khr)(
            physical_device,
            surface,
            p_surface_format_count as *mut _,
            p_surface_formats,
        );
    }
}
...
fn vk_get_swapchain_images_khr(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_swapchain_images_khr)(
            device,
            swapchain,
            p_swapchain_image_count as *mut _,
            p_swapchain_images,
        );
    }
}
...
fn vk_queue_present_khr(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_queue_present_khr)(queue, p_present_info);
    }
}
...
fn vk_cmd_debug_marker_end_ext(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_debug_marker_end_ext)(command_buffer);
    }
}
...
fn vk_get_fence_fd_khr(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_fence_fd_khr)(device, p_get_fd_info, p_fd);
    }
}
...
fn vk_release_display_ext(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_release_display_ext)(physical_device, display);
    }
}
...
fn vk_enumerate_physical_device_groups(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_enumerate_physical_device_groups)(
            instance,
            p_physical_device_group_count as *mut _,
...
fn vk_get_swapchain_status_khr(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_swapchain_status_khr)(device, swapchain);
    }
}
...
fn vk_get_past_presentation_timing_google(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_past_presentation_timing_google)(
            device,
            swapchain,
            p_presentation_timing_count as *mut _,
...
fn vk_queue_end_debug_utils_label_ext(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_queue_end_debug_utils_label_ext)(queue);
    }
}
...
fn vk_cmd_end_debug_utils_label_ext(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_end_debug_utils_label_ext)(command_buffer);
    }
}
...
fn vk_wait_semaphores(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_wait_semaphores)(device, p_wait_info, timeout);
    }
}
...
fn vk_signal_semaphore(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_signal_semaphore)(device, p_signal_info);
    }
}
...
fn vk_get_queue_checkpoint_data_nv(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_queue_checkpoint_data_nv)(
            queue,
            p_checkpoint_data_count as *mut _,
            p_checkpoint_data,
        );
    }
}
...
fn vk_compile_deferred_nv(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_compile_deferred_nv)(device, pipeline, shader);
    }
}
...
fn vk_get_image_view_handle_nvx(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_image_view_handle_nvx)(device, p_info);
    }
}
...
fn vk_acquire_profiling_lock_khr(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_acquire_profiling_lock_khr)(device, p_info);
    }
}
...
fn vk_release_profiling_lock_khr(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_release_profiling_lock_khr)(device);
    }
}
...
fn vk_get_buffer_device_address(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_buffer_device_address)(device, p_info);
    }
}
...
fn vk_uninitialize_performance_api_intel(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_uninitialize_performance_api_intel)(device);
    }
}
...
fn vk_get_pipeline_executable_internal_representations_khr(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_pipeline_executable_internal_representations_khr)(
            device,
            p_executable_info,
            p_internal_representation_count as *mut _,
...
fn vk_cmd_set_cull_mode(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_set_cull_mode)(command_buffer, cull_mode);
    }
}
...
fn vk_get_physical_device_fragment_shading_rates_khr(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_physical_device_fragment_shading_rates_khr)(
            physical_device,
            p_fragment_shading_rate_count as *mut _,
...
fn vk_get_physical_device_video_format_properties_khr(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_physical_device_video_format_properties_khr)(
            physical_device,
            p_video_format_info,
            p_video_format_property_count as *mut _,
...
fn vk_get_video_session_memory_requirements_khr(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_get_video_session_memory_requirements_khr)(
            device,
            video_session,
            p_memory_requirements_count as *mut _,
            p_memory_requirements,
        );
    }
}
...
fn vk_cmd_end_rendering(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_end_rendering)(command_buffer);
    }
}
...
fn vk_cmd_copy_micromap_ext(mut packet: Packet) {
    ...
    unsafe {
        (crate::FUNCTION_ADDRESS_TABLE.vk_cmd_copy_micromap_ext)(command_buffer, p_info);
    }
}
